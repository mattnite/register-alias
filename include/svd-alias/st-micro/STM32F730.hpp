...
struct STM32F730 {
    ...
    struct TIM1 {
        ...
        struct SMCR : public Register<0x40010008> {
            using SMS_3 = Field<16, 1>;    // Slave model selection - bit[3]
            ...
            using SMS = Field<0, 3>;    // Slave mode selection - bit[2:0]
        };
        ...
        struct CCR6 : public Register<0x4001005c> {
    ...
    struct TIM8 {
        ...
        // capture/compare register 6
        struct CCR6 : public Register<0x4001045c> {
            using Field = Field<0, 16>;    // Capture/Compare 6 value
        };
    ...
    struct EXTI {
        ...
        struct IMR : public Register<0x40013c00> {
            ...
            using MI9 = Field<9, 1>;    // Interrupt Mask on line 9
        ...
        struct RTSR : public Register<0x40013c08> {
            ...
            using TR23 = Field<23, 1>;    // Rising trigger event configuration of line 23
        };
        ...
        struct FTSR : public Register<0x40013c0c> {
            ...
            using TR23 = Field<23, 1>;    // Falling trigger event configuration of line 23
        };
        ...
        struct SWIER : public Register<0x40013c10> {
            ...
            using SWIER23 = Field<23, 1>;    // Software Interrupt on line 22
        };
        ...
        struct PR : public Register<0x40013c14> {
            ...
            using PR23 = Field<23, 1>;    // Pending bit 23
        };
    ...
    struct FLASH {
        ...
        struct SR : public Register<0x40023c0c> {
            ...
            using ERSERR = Field<7, 1>;    // Erase Sequence Error
            using BSY = Field<16, 1>;    // Busy
            using RDERR = Field<8, 1>;    // RDERR
        };
        ...
        struct CR : public Register<0x40023c10> {
            ...
            using MER = Field<2, 1>;    // Mass Erase of sectors 0 to 11
            ...
            using RDERRIE = Field<26, 1>;    // PCROP error interrupt enable
        };
        ...
        struct OPTCR : public Register<0x40023c14> {
            ...
            using IWDG_SW = Field<5, 1>;    // WDG_SW User option bytes
            ...
            using nWRP = Field<16, 8>;    // Not write protect
        ...
        // Flash option control register
        struct OPTCR2 : public Register<0x40023c1c> {
            using PCROP_RDP = Field<31, 1>;    // PCROP zone preserved when RDP level decreased
            using PCROPi = Field<0, 8>;    // PCROP option byte
        };
    ...
    struct FMC {
        ...
        struct SDSR : public Register<0xa0000158> {
    ...
    struct TIM5 {
        ...
        struct OR : public Register<0x40000c50> {
            using TI4_RMP = Field<6, 2>;    // Timer Input 4 remap
        };
    ...
    struct PWR {
        ...
        struct CSR1 : public Register<0x40007004> {
            ...
            using EIWUP = Field<8, 1>;    // Enable internal wakeup
        };
    ...
    struct RTC {
        ...
        struct OR : public Register<0x4000284c> {
            using RTC_ALARM_TYPE = Field<3, 1>;    // RTC_ALARM on PC13 output type
            using TSINSEL = Field<1, 1>;    // TIMESTAMP mapping
        };
    ...
    struct RCC {
        ...
        struct CR : public Register<0x40023800> {
            ...
            using PLLSAIRDY = Field<29, 1>;    // PLLSAI clock ready flag
            using PLLSAION = Field<28, 1>;    // PLLSAI enable
        };
        ...
        struct AHB2RSTR : public Register<0x40023814> {
            ...
            using AESRST = Field<4, 1>;    // AES module reset
        };
        ...
        struct APB2RSTR : public Register<0x40023824> {
            ...
            using SDMMC2RST = Field<7, 1>;    // SDMMC2 reset
            using USBPHYCRST = Field<31, 1>;    // USB OTG HS PHY controller reset
        };
        ...
        struct AHB1ENR : public Register<0x40023830> {
            ...
            using DTCMRAMEN = Field<20, 1>;    // CCM data RAM clock enable
        ...
        struct AHB2ENR : public Register<0x40023834> {
            ...
            using AESEN = Field<4, 1>;    // AES module clock enable
        };
        ...
        struct APB1ENR : public Register<0x40023840> {
            ...
            using LPTIM1EN = Field<9, 1>;    // Low power timer 1 clock enable
            using RTCAPBEN = Field<10, 1>;    // RTCAPB clock enable
        };
        ...
        struct APB2ENR : public Register<0x40023844> {
            ...
            using SDMMC2EN = Field<7, 1>;    // SDMMC2 clock enable
            using USBPHYCEN = Field<31, 1>;    // USB OTG HS PHY controller clock enable
        };
        ...
        struct AHB1LPENR : public Register<0x40023850> {
            ...
            using AXILPEN = Field<13, 1>;    // AXI to AHB bridge clock enable during Sleep mode
            using DTCMLPEN = Field<20, 1>;    // DTCM RAM interface clock enable during Sleep mode
        };
        ...
        struct AHB2LPENR : public Register<0x40023854> {
            ...
            using AESLPEN = Field<4, 1>;    // AES module clock enable during Sleep mode
        };
        ...
        struct APB2LPENR : public Register<0x40023864> {
            ...
            using SDMMC2LPEN = Field<7, 1>;    // SDMMC2 clock enable during Sleep mode
        };
        ...
        struct DCKCFGR1 : public Register<0x4002388c> {
        ...
        // dedicated clocks configuration register
        struct DCKCFGR2 : public Register<0x40023890> {
            using UART1SEL = Field<0, 2>;    // USART 1 clock source selection
            using UART2SEL = Field<2, 2>;    // USART 2 clock source selection
            using UART3SEL = Field<4, 2>;    // USART 3 clock source selection
            using UART4SEL = Field<6, 2>;    // UART 4 clock source selection
            using UART5SEL = Field<8, 2>;    // UART 5 clock source selection
            using UART6SEL = Field<10, 2>;    // USART 6 clock source selection
            ...
            using SDMMC1SEL = Field<28, 1>;    // SDMMC1 clock source selection
            using SDMMC2SEL = Field<29, 1>;    // SDMMC2 clock source selection
        };
    ...
    struct SDMMC2 {
        ...
        // command response register
        struct RESPCMD : public Register<0x40011c10> {
            using Field = Field<0, 6>;    // Response command index
        };

        // response 1..4 register
        struct RESP1 : public Register<0x40011c14> {
            using CARDSTATUS1 = Field<0, 32>;    // see Table 132
        };

        // response 1..4 register
        struct RESP2 : public Register<0x40011c18> {
            using CARDSTATUS2 = Field<0, 32>;    // see Table 132
        };

        // response 1..4 register
        struct RESP3 : public Register<0x40011c1c> {
            using CARDSTATUS3 = Field<0, 32>;    // see Table 132
        };

        // response 1..4 register
        struct RESP4 : public Register<0x40011c20> {
            using CARDSTATUS4 = Field<0, 32>;    // see Table 132
        };
        ...
        // data counter register
        struct DCOUNT : public Register<0x40011c30> {
            using DATACOUNT = Field<0, 25>;    // Data count value
        };

        // status register
        struct STA : public Register<0x40011c34> {
            using SDIOIT = Field<22, 1>;    // SDIO interrupt received
            using RXDAVL = Field<21, 1>;    // Data available in receive FIFO
            using TXDAVL = Field<20, 1>;    // Data available in transmit FIFO
            using RXFIFOE = Field<19, 1>;    // Receive FIFO empty
        ...
        // FIFO counter register
        struct FIFOCNT : public Register<0x40011c48> {
            using FIFOCOUNT = Field<0, 24>;    // Remaining number of words to be written to or read from the FIFO
        };
    ...
    struct SAI1 {
        ...
        struct BCR1 : public Register<0x40015824> {
            ...
            using SAIXEN = Field<16, 1>;    // Audio block B enable
        ...
        struct ACR1 : public Register<0x40015804> {
            ...
            using NODIV = Field<19, 1>;    // No divider
            using DMAEN = Field<17, 1>;    // DMA enable
            using SAIXEN = Field<16, 1>;    // Audio block A enable
            using OUTDRIV = Field<13, 1>;    // Output drive
            using MONO = Field<12, 1>;    // Mono mode
            using SYNCEN = Field<10, 2>;    // Synchronization enable
            using CKSTR = Field<9, 1>;    // Clock strobing edge
    ...
    struct SAI2 {
        ...
        // BStatus register
        struct BSR : public Register<0x40015c38> {
            using FLVL = Field<16, 3>;    // FIFO level threshold
            using LFSDET = Field<6, 1>;    // Late frame synchronization detection
            using AFSDET = Field<5, 1>;    // Anticipated frame synchronization detection
            using CNRDY = Field<4, 1>;    // Codec not ready
        ...
        // BClear flag register
        struct BCLRFR : public Register<0x40015c3c> {
            using CLFSDET = Field<6, 1>;    // Clear late frame synchronization detection flag
            using CAFSDET = Field<5, 1>;    // Clear anticipated frame synchronization detection flag
            using CCNRDY = Field<4, 1>;    // Clear codec not ready flag
            using CWCKCFG = Field<2, 1>;    // Clear wrong clock configuration flag
    ...
    struct SYSCFG {
        ...
        struct MEMRMP : public Register<0x40013800> {
            using MEM_BOOT = Field<0, 1>;    // Memory boot mapping
            using SWP_FMC = Field<10, 2>;    // FMC memory mapping swap
        };

        // peripheral mode configuration register
        struct PMC : public Register<0x40013804> {
            using PB7_FMP = Field<5, 1>;    // PB7_FMP Fast Mode + Enable
            using PB8_FMP = Field<6, 1>;    // PB8_FMP Fast Mode + Enable
            using PB9_FMP = Field<7, 1>;    // Fast Mode + Enable
            using ADCDC2 = Field<16, 3>;    // ADC3DC2
            using PB6_FMP = Field<4, 1>;    // PB6_FMP Fast Mode
            using I2C3_FMP = Field<2, 1>;    // I2C3_FMP I2C3 Fast Mode + Enable
            using I2C2_FMP = Field<1, 1>;    // I2C2_FMP I2C2 Fast Mode + Enable
            using I2C1_FMP = Field<0, 1>;    // I2C1_FMP I2C1 Fast Mode + Enable
        };
    ...
    struct USART3 {
        ...
        struct BRR : public Register<0x4000480c> {
            using Field = Field<0, 16>;    // USARTDIV
        };
        ...
        struct ICR : public Register<0x40004820> {
            ...
            using TCBGTCF = Field<7, 1>;    // Transmission completed before guard time clear flag
        };
    ...
    struct UART8 {
        ...
        // Request register
        struct RQR : public Register<0x40007c18> {
            using TXFRQ = Field<4, 1>;    // Transmit data flush request
            using RXFRQ = Field<3, 1>;    // Receive data flush request
            using MMRQ = Field<2, 1>;    // Mute mode request
            using SBKRQ = Field<1, 1>;    // Send break request
        ...
        // Interrupt & status register
        struct ISR : public Register<0x40007c1c> {
            using TEACK = Field<21, 1>;    // TEACK
            using SBKF = Field<18, 1>;    // SBKF
            using CMF = Field<17, 1>;    // CMF
            using BUSY = Field<16, 1>;    // BUSY
        ...
        // Interrupt flag clear register
        struct ICR : public Register<0x40007c20> {
            using CMCF = Field<17, 1>;    // Character match clear flag
            using EOBCF = Field<12, 1>;    // End of block clear flag
            using RTOCF = Field<11, 1>;    // Receiver timeout clear flag
            using CTSCF = Field<9, 1>;    // CTS clear flag
        ...
        // Receive data register
        struct RDR : public Register<0x40007c24> {
            using Field = Field<0, 9>;    // Receive data value
        };
    ...
    struct UART7 {
        ...
        // Request register
        struct RQR : public Register<0x40007818> {
            using TXFRQ = Field<4, 1>;    // Transmit data flush request
            using RXFRQ = Field<3, 1>;    // Receive data flush request
            using MMRQ = Field<2, 1>;    // Mute mode request
            using SBKRQ = Field<1, 1>;    // Send break request
        ...
        // Interrupt & status register
        struct ISR : public Register<0x4000781c> {
            using TEACK = Field<21, 1>;    // TEACK
            using SBKF = Field<18, 1>;    // SBKF
            using CMF = Field<17, 1>;    // CMF
            using BUSY = Field<16, 1>;    // BUSY
        ...
        // Interrupt flag clear register
        struct ICR : public Register<0x40007820> {
            using CMCF = Field<17, 1>;    // Character match clear flag
            using EOBCF = Field<12, 1>;    // End of block clear flag
            using RTOCF = Field<11, 1>;    // Receiver timeout clear flag
            using CTSCF = Field<9, 1>;    // CTS clear flag
        ...
        // Receive data register
        struct RDR : public Register<0x40007824> {
            using Field = Field<0, 9>;    // Receive data value
        };
    ...
    struct USART1 {
        ...
        // Request register
        struct RQR : public Register<0x40011018> {
            using TXFRQ = Field<4, 1>;    // Transmit data flush request
            using RXFRQ = Field<3, 1>;    // Receive data flush request
            using MMRQ = Field<2, 1>;    // Mute mode request
            using SBKRQ = Field<1, 1>;    // Send break request
        ...
        // Interrupt & status register
        struct ISR : public Register<0x4001101c> {
            using TEACK = Field<21, 1>;    // TEACK
            using SBKF = Field<18, 1>;    // SBKF
            using CMF = Field<17, 1>;    // CMF
            using BUSY = Field<16, 1>;    // BUSY
        ...
        // Interrupt flag clear register
        struct ICR : public Register<0x40011020> {
            using CMCF = Field<17, 1>;    // Character match clear flag
            using EOBCF = Field<12, 1>;    // End of block clear flag
            using RTOCF = Field<11, 1>;    // Receiver timeout clear flag
            using CTSCF = Field<9, 1>;    // CTS clear flag
        ...
        // Receive data register
        struct RDR : public Register<0x40011024> {
            using Field = Field<0, 9>;    // Receive data value
        };
    ...
    struct OTG_FS_GLOBAL {
        ...
        struct OTG_FS_GRXSTSR_Device : public Register<0x5000001c> {
        ...
        struct OTG_FS_GRXSTSR_Host : public Register<0x5000001c> {
        ...
        struct OTG_FS_HNPTXSTS : public Register<0x5000002c> {
        ...
        struct OTG_FS_GRXSTSP_Device : public Register<0x50000020> {
            using EPNUM = Field<0, 4>;    // Endpoint number
            using BCNT = Field<4, 11>;    // Byte count
            using DPID = Field<15, 2>;    // Data PID
            using PKTSTS = Field<17, 4>;    // Packet status
        ...
        struct OTG_FS_GRXSTSP_Host : public Register<0x50000020> {
    ...
    struct OTG_FS_HOST {
        ...
        struct OTG_FS_HFNUM : public Register<0x50000408> {
        ...
        struct OTG_FS_HAINT : public Register<0x50000414> {
        ...
        struct OTG_FS_HCCHAR8 : public Register<0x50000600> {
            using MPSIZ = Field<0, 11>;    // Maximum packet size
            using EPNUM = Field<11, 4>;    // Endpoint number
            using EPDIR = Field<15, 1>;    // Endpoint direction
            using LSDEV = Field<17, 1>;    // Low-speed device
        ...
        struct OTG_FS_HCINT8 : public Register<0x50000608> {
            using XFRC = Field<0, 1>;    // Transfer completed
            using CHH = Field<1, 1>;    // Channel halted
            using STALL = Field<3, 1>;    // STALL response received interrupt
            using NAK = Field<4, 1>;    // NAK response received interrupt
        ...
        struct OTG_FS_HCINTMSK8 : public Register<0x5000060c> {
            using XFRCM = Field<0, 1>;    // Transfer completed mask
            using CHHM = Field<1, 1>;    // Channel halted mask
            using STALLM = Field<3, 1>;    // STALL response received interrupt mask
            using NAKM = Field<4, 1>;    // NAK response received interrupt mask
        ...
        struct OTG_FS_HCTSIZ8 : public Register<0x50000610> {
            using XFRSIZ = Field<0, 19>;    // Transfer size
            using PKTCNT = Field<19, 10>;    // Packet count
            using DPID = Field<29, 2>;    // Data PID
        };
        ...
        struct OTG_FS_HCCHAR9 : public Register<0x50000620> {
            using MPSIZ = Field<0, 11>;    // Maximum packet size
            using EPNUM = Field<11, 4>;    // Endpoint number
            using EPDIR = Field<15, 1>;    // Endpoint direction
            using LSDEV = Field<17, 1>;    // Low-speed device
        ...
        struct OTG_FS_HCINT9 : public Register<0x50000628> {
            using XFRC = Field<0, 1>;    // Transfer completed
            using CHH = Field<1, 1>;    // Channel halted
            using STALL = Field<3, 1>;    // STALL response received interrupt
            using NAK = Field<4, 1>;    // NAK response received interrupt
        ...
        struct OTG_FS_HCINTMSK9 : public Register<0x5000062c> {
            using XFRCM = Field<0, 1>;    // Transfer completed mask
            using CHHM = Field<1, 1>;    // Channel halted mask
            using STALLM = Field<3, 1>;    // STALL response received interrupt mask
            using NAKM = Field<4, 1>;    // NAK response received interrupt mask
        ...
        struct OTG_FS_HCTSIZ9 : public Register<0x50000630> {
            using XFRSIZ = Field<0, 19>;    // Transfer size
            using PKTCNT = Field<19, 10>;    // Packet count
            using DPID = Field<29, 2>;    // Data PID
        };
        ...
        struct OTG_FS_HCCHAR10 : public Register<0x50000640> {
            using MPSIZ = Field<0, 11>;    // Maximum packet size
            using EPNUM = Field<11, 4>;    // Endpoint number
            using EPDIR = Field<15, 1>;    // Endpoint direction
            using LSDEV = Field<17, 1>;    // Low-speed device
        ...
        struct OTG_FS_HCINT10 : public Register<0x50000648> {
            using XFRC = Field<0, 1>;    // Transfer completed
            using CHH = Field<1, 1>;    // Channel halted
            using STALL = Field<3, 1>;    // STALL response received interrupt
            using NAK = Field<4, 1>;    // NAK response received interrupt
        ...
        struct OTG_FS_HCINTMSK10 : public Register<0x5000064c> {
            using XFRCM = Field<0, 1>;    // Transfer completed mask
            using CHHM = Field<1, 1>;    // Channel halted mask
            using STALLM = Field<3, 1>;    // STALL response received interrupt mask
            using NAKM = Field<4, 1>;    // NAK response received interrupt mask
        ...
        struct OTG_FS_HCTSIZ10 : public Register<0x50000650> {
            using XFRSIZ = Field<0, 19>;    // Transfer size
            using PKTCNT = Field<19, 10>;    // Packet count
            using DPID = Field<29, 2>;    // Data PID
        };
        ...
        struct OTG_FS_HCCHAR11 : public Register<0x50000660> {
            using MPSIZ = Field<0, 11>;    // Maximum packet size
            using EPNUM = Field<11, 4>;    // Endpoint number
            using EPDIR = Field<15, 1>;    // Endpoint direction
            using LSDEV = Field<17, 1>;    // Low-speed device
        ...
        struct OTG_FS_HCINT11 : public Register<0x50000668> {
            using XFRC = Field<0, 1>;    // Transfer completed
            using CHH = Field<1, 1>;    // Channel halted
            using STALL = Field<3, 1>;    // STALL response received interrupt
            using NAK = Field<4, 1>;    // NAK response received interrupt
        ...
        struct OTG_FS_HCINTMSK11 : public Register<0x5000066c> {
            using XFRCM = Field<0, 1>;    // Transfer completed mask
            using CHHM = Field<1, 1>;    // Channel halted mask
            using STALLM = Field<3, 1>;    // STALL response received interrupt mask
            using NAKM = Field<4, 1>;    // NAK response received interrupt mask
        ...
        struct OTG_FS_HCTSIZ11 : public Register<0x50000670> {
            using XFRSIZ = Field<0, 19>;    // Transfer size
            using PKTCNT = Field<19, 10>;    // Packet count
            using DPID = Field<29, 2>;    // Data PID
        };
    ...
    struct OTG_FS_DEVICE {
        ...
        struct OTG_FS_DSTS : public Register<0x50000808> {
        ...
        struct OTG_FS_DAINT : public Register<0x50000818> {
        ...
        struct OTG_FS_DTXFSTS0 : public Register<0x50000918> {
            using INEPTFSAV = Field<0, 16>;    // IN endpoint TxFIFO space available
        };

        // OTG_FS device IN endpoint transmit FIFO status register
        struct OTG_FS_DTXFSTS1 : public Register<0x50000938> {
            using INEPTFSAV = Field<0, 16>;    // IN endpoint TxFIFO space available
        };

        // OTG_FS device IN endpoint transmit FIFO status register
        struct OTG_FS_DTXFSTS2 : public Register<0x50000958> {
            using INEPTFSAV = Field<0, 16>;    // IN endpoint TxFIFO space available
        };

        // OTG_FS device IN endpoint transmit FIFO status register
        struct OTG_FS_DTXFSTS3 : public Register<0x50000978> {
            using INEPTFSAV = Field<0, 16>;    // IN endpoint TxFIFO space available
        };
        ...
        struct OTG_FS_DIEPTSIZ4 : public Register<0x50000990> {
            using MCNT = Field<29, 2>;    // Multi count
            using PKTCNT = Field<19, 10>;    // Packet count
            using XFRSIZ = Field<0, 19>;    // Transfer size
        };
        ...
        // OTG_FS device IN endpoint transmit FIFO status register
        struct OTG_FS_DTXFSTS4 : public Register<0x50000998> {
            using INEPTFSAV = Field<0, 16>;    // IN endpoint TxFIFO space available
        };
        ...
        struct OTG_FS_DIEPTSIZ5 : public Register<0x500009b0> {
            using MCNT = Field<29, 2>;    // Multi count
            using PKTCNT = Field<19, 10>;    // Packet count
            using XFRSIZ = Field<0, 19>;    // Transfer size
        };
        ...
        // OTG_FS device IN endpoint transmit FIFO status register
        struct OTG_FS_DTXFSTS5 : public Register<0x500009b8> {
            using INEPTFSAV = Field<0, 16>;    // IN endpoint TxFIFO space available
        };

        // device endpoint-4 control register
        struct OTG_FS_DOEPCTL4 : public Register<0x50000b80> {
            using EPENA = Field<31, 1>;    // EPENA
            using EPDIS = Field<30, 1>;    // EPDIS
            using SODDFRM = Field<29, 1>;    // SODDFRM
            using SD0PID_SEVNFRM = Field<28, 1>;    // SD0PID/SEVNFRM
        ...
        // device endpoint-4 interrupt register
        struct OTG_FS_DOEPINT4 : public Register<0x50000b88> {
            using B2BSTUP = Field<6, 1>;    // B2BSTUP
            using OTEPDIS = Field<4, 1>;    // OTEPDIS
            using STUP = Field<3, 1>;    // STUP
            using EPDISD = Field<1, 1>;    // EPDISD
        ...
        struct OTG_FS_DOEPTSIZ4 : public Register<0x50000b90> {
            using RXDPID_STUPCNT = Field<29, 2>;    // Received data PID/SETUP packet count
            using PKTCNT = Field<19, 10>;    // Packet count
            using XFRSIZ = Field<0, 19>;    // Transfer size
        };
        ...
        struct OTG_FS_DOEPCTL5 : public Register<0x50000ba0> {
            using EPENA = Field<31, 1>;    // EPENA
            using EPDIS = Field<30, 1>;    // EPDIS
            using SODDFRM = Field<29, 1>;    // SODDFRM
            using SD0PID_SEVNFRM = Field<28, 1>;    // SD0PID/SEVNFRM
        ...
        // device endpoint-5 interrupt register
        struct OTG_FS_DOEPINT5 : public Register<0x50000ba8> {
            using B2BSTUP = Field<6, 1>;    // B2BSTUP
            using OTEPDIS = Field<4, 1>;    // OTEPDIS
            using STUP = Field<3, 1>;    // STUP
            using EPDISD = Field<1, 1>;    // EPDISD
        ...
        struct OTG_FS_DOEPTSIZ5 : public Register<0x50000bb0> {
            using RXDPID_STUPCNT = Field<29, 2>;    // Received data PID/SETUP packet count
            using PKTCNT = Field<19, 10>;    // Packet count
            using XFRSIZ = Field<0, 19>;    // Transfer size
        };
    ...
    struct OTG_HS_HOST {
        ...
        struct OTG_HS_HCCHAR12 : public Register<0x40040680> {
            using MPSIZ = Field<0, 11>;    // Maximum packet size
            using EPNUM = Field<11, 4>;    // Endpoint number
            using EPDIR = Field<15, 1>;    // Endpoint direction
            using LSDEV = Field<17, 1>;    // Low-speed device
        ...
        struct OTG_HS_HCSPLT12 : public Register<0x40040684> {
            using PRTADDR = Field<0, 7>;    // Port address
            using HUBADDR = Field<7, 7>;    // Hub address
            using XACTPOS = Field<14, 2>;    // XACTPOS
            using COMPLSPLT = Field<16, 1>;    // Do complete split
        ...
        struct OTG_HS_HCINT12 : public Register<0x40040688> {
            using XFRC = Field<0, 1>;    // Transfer completed
            using CHH = Field<1, 1>;    // Channel halted
            using AHBERR = Field<2, 1>;    // AHB error
            using STALL = Field<3, 1>;    // STALL response received interrupt
        ...
        struct OTG_HS_HCINTMSK12 : public Register<0x4004068c> {
            using XFRCM = Field<0, 1>;    // Transfer completed mask
            using CHHM = Field<1, 1>;    // Channel halted mask
            using AHBERR = Field<2, 1>;    // AHB error
            using STALLM = Field<3, 1>;    // STALL response received interrupt mask
        ...
        struct OTG_HS_HCTSIZ12 : public Register<0x40040690> {
            using XFRSIZ = Field<0, 19>;    // Transfer size
            using PKTCNT = Field<19, 10>;    // Packet count
            using DPID = Field<29, 2>;    // Data PID
        };
        ...
        struct OTG_HS_HCDMA12 : public Register<0x40040694> {
            using DMAADDR = Field<0, 32>;    // DMA address
        };

        // OTG_HS host channel-13 characteristics register
        struct OTG_HS_HCCHAR13 : public Register<0x400406a0> {
            using MPSIZ = Field<0, 11>;    // Maximum packet size
            using EPNUM = Field<11, 4>;    // Endpoint number
            using EPDIR = Field<15, 1>;    // Endpoint direction
            using LSDEV = Field<17, 1>;    // Low-speed device
        ...
        struct OTG_HS_HCSPLT13 : public Register<0x400406a4> {
            using PRTADDR = Field<0, 7>;    // Port address
            using HUBADDR = Field<7, 7>;    // Hub address
            using XACTPOS = Field<14, 2>;    // XACTPOS
            using COMPLSPLT = Field<16, 1>;    // Do complete split
        ...
        struct OTG_HS_HCINT13 : public Register<0x400406a8> {
            using XFRC = Field<0, 1>;    // Transfer completed
            using CHH = Field<1, 1>;    // Channel halted
            using AHBERR = Field<2, 1>;    // AHB error
            using STALL = Field<3, 1>;    // STALL response received interrupt
        ...
        struct OTG_HS_HCINTMSK13 : public Register<0x400406ac> {
            using XFRCM = Field<0, 1>;    // Transfer completed mask
            using CHHM = Field<1, 1>;    // Channel halted mask
            using AHBERR = Field<2, 1>;    // AHB error
        ...
        struct OTG_HS_HCTSIZ13 : public Register<0x400406b0> {
            using XFRSIZ = Field<0, 19>;    // Transfer size
            using PKTCNT = Field<19, 10>;    // Packet count
            using DPID = Field<29, 2>;    // Data PID
        };
        ...
        struct OTG_HS_HCDMA13 : public Register<0x400406b4> {
            using DMAADDR = Field<0, 32>;    // DMA address
        };

        // OTG_HS host channel-14 characteristics register
        struct OTG_HS_HCCHAR14 : public Register<0x400406c0> {
            using MPSIZ = Field<0, 11>;    // Maximum packet size
            using EPNUM = Field<11, 4>;    // Endpoint number
            using EPDIR = Field<15, 1>;    // Endpoint direction
            using LSDEV = Field<17, 1>;    // Low-speed device
        ...
        struct OTG_HS_HCSPLT14 : public Register<0x400406c4> {
            using PRTADDR = Field<0, 7>;    // Port address
            using HUBADDR = Field<7, 7>;    // Hub address
            using XACTPOS = Field<14, 2>;    // XACTPOS
            using COMPLSPLT = Field<16, 1>;    // Do complete split
        ...
        struct OTG_HS_HCINT14 : public Register<0x400406c8> {
            using XFRC = Field<0, 1>;    // Transfer completed
            using CHH = Field<1, 1>;    // Channel halted
            using AHBERR = Field<2, 1>;    // AHB error
            using STALL = Field<3, 1>;    // STALL response received interrupt
        ...
        struct OTG_HS_HCINTMSK14 : public Register<0x400406cc> {
            using XFRCM = Field<0, 1>;    // Transfer completed mask
            using CHHM = Field<1, 1>;    // Channel halted mask
            using AHBERR = Field<2, 1>;    // AHB error
            using STALLM = Field<3, 1>;    // STALL response received interrupt mask
        ...
        struct OTG_HS_HCTSIZ14 : public Register<0x400406d0> {
            using XFRSIZ = Field<0, 19>;    // Transfer size
            using PKTCNT = Field<19, 10>;    // Packet count
            using DPID = Field<29, 2>;    // Data PID
        };
        ...
        struct OTG_HS_HCDMA14 : public Register<0x400406d4> {
            using DMAADDR = Field<0, 32>;    // DMA address
        };

        // OTG_HS host channel-15 characteristics register
        struct OTG_HS_HCCHAR15 : public Register<0x400406e0> {
            using MPSIZ = Field<0, 11>;    // Maximum packet size
            using EPNUM = Field<11, 4>;    // Endpoint number
            using EPDIR = Field<15, 1>;    // Endpoint direction
            using LSDEV = Field<17, 1>;    // Low-speed device
        ...
        struct OTG_HS_HCSPLT15 : public Register<0x400406e4> {
            using PRTADDR = Field<0, 7>;    // Port address
            using HUBADDR = Field<7, 7>;    // Hub address
            using XACTPOS = Field<14, 2>;    // XACTPOS
            using COMPLSPLT = Field<16, 1>;    // Do complete split
        ...
        struct OTG_HS_HCINT15 : public Register<0x400406e8> {
            using XFRC = Field<0, 1>;    // Transfer completed
            using CHH = Field<1, 1>;    // Channel halted
            using AHBERR = Field<2, 1>;    // AHB error
            using STALL = Field<3, 1>;    // STALL response received interrupt
        ...
        struct OTG_HS_HCINTMSK15 : public Register<0x400406ec> {
            using XFRCM = Field<0, 1>;    // Transfer completed mask
            using CHHM = Field<1, 1>;    // Channel halted mask
            using AHBERR = Field<2, 1>;    // AHB error
        ...
        struct OTG_HS_HCTSIZ15 : public Register<0x400406f0> {
            using XFRSIZ = Field<0, 19>;    // Transfer size
            using PKTCNT = Field<19, 10>;    // Packet count
            using DPID = Field<29, 2>;    // Data PID
        };
        ...
        struct OTG_HS_HCDMA15 : public Register<0x400406f4> {
            using DMAADDR = Field<0, 32>;    // DMA address
        };
    ...
    struct OTG_HS_GLOBAL {
        ...
        struct OTG_HS_HNPTXSTS : public Register<0x4004002c> {
        ...
        // OTG_HS device IN endpoint transmit FIFO size register
        struct OTG_HS_DIEPTXF3 : public Register<0x4004010c> {
            using INEPTXSA = Field<0, 16>;    // IN endpoint FIFOx transmit RAM start address
            using INEPTXFD = Field<16, 16>;    // IN endpoint TxFIFO depth
        };

        // OTG_HS device IN endpoint transmit FIFO size register
        struct OTG_HS_DIEPTXF4 : public Register<0x40040110> {
            using INEPTXSA = Field<0, 16>;    // IN endpoint FIFOx transmit RAM start address
            using INEPTXFD = Field<16, 16>;    // IN endpoint TxFIFO depth
        };

        // OTG_HS device IN endpoint transmit FIFO size register
        struct OTG_HS_DIEPTXF5 : public Register<0x40040114> {
            using INEPTXSA = Field<0, 16>;    // IN endpoint FIFOx transmit RAM start address
            using INEPTXFD = Field<16, 16>;    // IN endpoint TxFIFO depth
        };

        // OTG_HS device IN endpoint transmit FIFO size register
        struct OTG_HS_DIEPTXF6 : public Register<0x40040118> {
            using INEPTXSA = Field<0, 16>;    // IN endpoint FIFOx transmit RAM start address
            using INEPTXFD = Field<16, 16>;    // IN endpoint TxFIFO depth
        };

        // OTG_HS device IN endpoint transmit FIFO size register
        struct OTG_HS_DIEPTXF7 : public Register<0x4004011c> {
            using INEPTXSA = Field<0, 16>;    // IN endpoint FIFOx transmit RAM start address
            using INEPTXFD = Field<16, 16>;    // IN endpoint TxFIFO depth
        };

        // OTG_HS Receive status debug read register (peripheral mode mode)
        struct OTG_HS_GRXSTSR_Device : public Register<0x4004001c> {
            using EPNUM = Field<0, 4>;    // Endpoint number
            using BCNT = Field<4, 11>;    // Byte count
            using DPID = Field<15, 2>;    // Data PID
            using PKTSTS = Field<17, 4>;    // Packet status
        ...
        struct OTG_HS_GRXSTSP_Device : public Register<0x40040020> {
            using EPNUM = Field<0, 4>;    // Endpoint number
            using BCNT = Field<4, 11>;    // Byte count
            using DPID = Field<15, 2>;    // Data PID
            using PKTSTS = Field<17, 4>;    // Packet status
        ...
        // OTG I2C access register
        struct OTG_HS_GI2CCTL : public Register<0x40040030> {
            using BSYDNE = Field<31, 1>;    // I2C Busy/Done
            using RW = Field<30, 1>;    // Read/Write Indicator
            using I2CDATSE0 = Field<28, 1>;    // I2C DatSe0 USB mode
            using I2CDEVADR = Field<26, 2>;    // I2C Device Address
    ...
    struct OTG_HS_DEVICE {
        ...
        struct OTG_HS_DIEPDMA0 : public Register<0x40040914> {
            using DMAADDR = Field<0, 32>;    // DMA address
        };

        // OTG_HS device endpoint-2 DMA address register
        struct OTG_HS_DIEPDMA1 : public Register<0x40040934> {
            using DMAADDR = Field<0, 32>;    // DMA address
        };

        // OTG_HS device endpoint-3 DMA address register
        struct OTG_HS_DIEPDMA2 : public Register<0x40040954> {
            using DMAADDR = Field<0, 32>;    // DMA address
        };

        // OTG_HS device endpoint-4 DMA address register
        struct OTG_HS_DIEPDMA3 : public Register<0x40040974> {
            using DMAADDR = Field<0, 32>;    // DMA address
        };

        // OTG_HS device endpoint-5 DMA address register
        struct OTG_HS_DIEPDMA4 : public Register<0x40040994> {
            using DMAADDR = Field<0, 32>;    // DMA address
        };
        ...
        // OTG_HS device endpoint transfer size register
        struct OTG_HS_DIEPTSIZ6 : public Register<0x400409d0> {
            using XFRSIZ = Field<0, 19>;    // Transfer size
            using PKTCNT = Field<19, 10>;    // Packet count
            using MCNT = Field<29, 2>;    // Multi count
        };
        ...
        // OTG_HS device IN endpoint transmit FIFO status register
        struct OTG_HS_DTXFSTS6 : public Register<0x400409d8> {
            using INEPTFSAV = Field<0, 16>;    // IN endpoint TxFIFO space avail
        };

        // OTG_HS device endpoint transfer size register
        struct OTG_HS_DIEPTSIZ7 : public Register<0x400409f0> {
            using XFRSIZ = Field<0, 19>;    // Transfer size
            using PKTCNT = Field<19, 10>;    // Packet count
            using MCNT = Field<29, 2>;    // Multi count
        };
        ...
        // OTG_HS device IN endpoint transmit FIFO status register
        struct OTG_HS_DTXFSTS7 : public Register<0x400409f8> {
            using INEPTFSAV = Field<0, 16>;    // IN endpoint TxFIFO space avail
        };
        ...
        struct OTG_HS_DOEPDMA0 : public Register<0x40040b14> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DOEPDMA1 : public Register<0x40040b34> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DOEPDMA2 : public Register<0x40040b54> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DOEPDMA3 : public Register<0x40040b74> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DOEPDMA4 : public Register<0x40040b94> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DOEPDMA5 : public Register<0x40040bb4> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DOEPDMA6 : public Register<0x40040bd4> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DOEPDMA7 : public Register<0x40040bf4> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DOEPDMA8 : public Register<0x40040c14> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DOEPDMA9 : public Register<0x40040c34> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DOEPDMA10 : public Register<0x40040c54> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DOEPDMA11 : public Register<0x40040c74> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DOEPDMA12 : public Register<0x40040c94> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DOEPDMA13 : public Register<0x40040cb4> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DOEPDMA14 : public Register<0x40040cd4> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DOEPDMA15 : public Register<0x40040cf4> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DIEPDMA5 : public Register<0x400409b4> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DIEPDMA6 : public Register<0x400409d4> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DIEPDMA7 : public Register<0x400409f4> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DIEPDMA8 : public Register<0x40040a14> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DIEPDMA9 : public Register<0x40040a34> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DIEPDMA10 : public Register<0x40040a54> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DIEPDMA11 : public Register<0x40040a74> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DIEPDMA12 : public Register<0x40040a94> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DIEPDMA13 : public Register<0x40040ab4> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DIEPDMA14 : public Register<0x40040ad4> {
        };

        // OTG Device channel-x DMA address register
        struct OTG_HS_DIEPDMA15 : public Register<0x40040af4> {
        };
    ...
    struct PF {
        ...
        struct CLIDR : public Register<0xe000ed78> {
        ...
        // Cache Type register
        struct CTR : public Register<0xe000ed7c> {
        ...
        struct CCSIDR : public Register<0xe000ed80> {
    ...
    struct AES {
        ...
        struct CR : public Register<0x50060000> {
            using KEYSIZE = Field<18, 1>;    // Key size selection
            using CHMOD2 = Field<16, 1>;    // AES chaining mode Bit2
            using GCMPH = Field<13, 2>;    // Used only for GCM, CCM and GMAC algorithms and has no effect when other algorithms are selected
            ...
            using CHMOD10 = Field<5, 2>;    // AES chaining mode Bit1 Bit0
        ...
        struct SR : public Register<0x50060004> {
            using BUSY = Field<3, 1>;    // Busy flag
        ...
        struct KEYR4 : public Register<0x50060030> {
            using AES_KEYR4 = Field<0, 32>;    // AES key register (MSB key [159:128])
        };

        // key register 5
        struct KEYR5 : public Register<0x50060034> {
            using AES_KEYR5 = Field<0, 32>;    // AES key register (MSB key [191:160])
        };

        // key register 6
        struct KEYR6 : public Register<0x50060038> {
            using AES_KEYR6 = Field<0, 32>;    // AES key register (MSB key [223:192])
        };

        // key register 7
        struct KEYR7 : public Register<0x5006003c> {
            using AES_KEYR7 = Field<0, 32>;    // AES key register (MSB key [255:224])
        };

        // AES suspend register 0
        struct SUSP0R : public Register<0x50060040> {
            using AES_SUSP0R = Field<0, 32>;    // AES suspend register 0
        };

        // AES suspend register 1
        struct SUSP1R : public Register<0x50060044> {
            using AES_SUSP1R = Field<0, 32>;    // AES suspend register 1
        };

        // AES suspend register 2
        struct SUSP2R : public Register<0x50060048> {
            using AES_SUSP2R = Field<0, 32>;    // AES suspend register 2
        };

        // AES suspend register 3
        struct SUSP3R : public Register<0x5006004c> {
            using AES_SUSP3R = Field<0, 32>;    // AES suspend register 3
        };

        // AES suspend register 4
        struct SUSP4R : public Register<0x50060050> {
            using AES_SUSP4R = Field<0, 32>;    // AES suspend register 4
        };

        // AES suspend register 5
        struct SUSP5R : public Register<0x50060054> {
            using AES_SUSP5R = Field<0, 32>;    // AES suspend register 5
        };

        // AES suspend register 6
        struct SUSP6R : public Register<0x50060058> {
            using AES_SUSP6R = Field<0, 32>;    // AES suspend register 6
        };

        // AES suspend register 7
        struct SUSP7R : public Register<0x5006005c> {
            using AES_SUSP7R = Field<0, 32>;    // AES suspend register 7
        };
    ...
    struct USBPHYC {
        ...
        struct PLL1 : public Register<0x40017c00> {
            using PLL1EN = Field<0, 1>;    // Enable the PLL1 inside PHY
            using PLL1SEL = Field<1, 3>;    // : Controls the PHY PLL1 input clock frequency selection
        };

        // USBPHYC tuning control register
        struct TUNE : public Register<0x40017c0c> {
            using INCURREN = Field<0, 1>;    // Controls the current boosting function
            using INCURRINT = Field<1, 1>;    // Controls PHY current boosting
            using LFSCAPEN = Field<2, 1>;    // : Enables the Low Full Speed feedback capacitor
            using HSDRVSLEW = Field<3, 1>;    // Controls the HS driver slew rate
            using HSDRVDCCUR = Field<4, 1>;    // Decreases the HS driver DC level
            using HSDRVDCLEV = Field<5, 1>;    // Increases the HS Driver DC level. Not applicable during the HS Test J and Test K data transfer
            using HSDRVCURINCR = Field<6, 1>;    // Enable the HS driver current increase feature
            using FSDRVRFADJ = Field<7, 1>;    // Tuning pin to adjust the full speed rise/fall time
            using HSDRVRFRED = Field<8, 1>;    // High Speed rise-fall reduction enable
            using HSDRVCHKITRM = Field<9, 4>;    // HS Driver current trimming pins for choke compensation
            using HSDRVCHKZTRM = Field<13, 2>;    // Controls the PHY bus HS driver impedance tuning for choke compensation
            using SQLCHCTL = Field<15, 2>;    // Adjust the squelch DC threshold value
            using HDRXGNEQEN = Field<17, 1>;    // Enables the HS Rx Gain Equalizer
            using STAGSEL = Field<18, 1>;    // HS Tx staggering enable
            using HSFALLPREEM = Field<19, 1>;    // HS Fall time control of single ended signals during pre-emphasis
            using HSRXOFF = Field<20, 2>;    // : HS Receiver Offset adjustment
            using SHTCCTCTLPROT = Field<22, 1>;    // Enables the short circuit protection circuitry in LS/FS driver
            using SQLBYP = Field<23, 1>;    // This pin is used to bypass the squelch inter-locking circuitry
        };

        // USBPHYC LDO control and status register
        struct LDO : public Register<0x40017c18> {
            using LDO_USED = Field<0, 1>;    // Indicates the presence of the LDO in the chip
            using LDO_STATUS = Field<1, 1>;    // Monitors the status of the PHY's LDO
            using LDO_DISABLE = Field<2, 1>;    // Controls disable of the High Speed PHY's LDO
        };
