...
struct STM32F0x2 {
    ...
    struct EXTI {
        ...
        struct PR : public Register<0x40010414> {
            using PIF31 = Field<31, 1>;    // Pending interrupt flag on line 31
            using PIF22 = Field<22, 1>;    // Pending interrupt flag on line 22
            using PIF21 = Field<21, 1>;    // Pending interrupt flag on line 21
            using PIF20 = Field<20, 1>;    // Pending interrupt flag on line 20
            using PIF19 = Field<19, 1>;    // Pending interrupt flag on line 19
            using PIF17 = Field<17, 1>;    // Pending interrupt flag on line 17
            using PIF16 = Field<16, 1>;    // Pending interrupt flag on line 16
            using PIF15 = Field<15, 1>;    // Pending interrupt flag on line 15
            using PIF14 = Field<14, 1>;    // Pending interrupt flag on line 14
            using PIF13 = Field<13, 1>;    // Pending interrupt flag on line 13
            using PIF12 = Field<12, 1>;    // Pending interrupt flag on line 12
            using PIF11 = Field<11, 1>;    // Pending interrupt flag on line 11
            using PIF10 = Field<10, 1>;    // Pending interrupt flag on line 10
            using PIF9 = Field<9, 1>;    // Pending interrupt flag on line 9
            using PIF8 = Field<8, 1>;    // Pending interrupt flag on line 8
            using PIF7 = Field<7, 1>;    // Pending interrupt flag on line 7
            using PIF6 = Field<6, 1>;    // Pending interrupt flag on line 6
            using PIF5 = Field<5, 1>;    // Pending interrupt flag on line 5
            using PIF4 = Field<4, 1>;    // Pending interrupt flag on line 4
            using PIF3 = Field<3, 1>;    // Pending interrupt flag on line 3
            using PIF2 = Field<2, 1>;    // Pending interrupt flag on line 2
            using PIF1 = Field<1, 1>;    // Pending interrupt flag on line 1
            using PIF0 = Field<0, 1>;    // Pending interrupt flag on line 0
        };
    ...
    struct Flash {
        ...
        struct OBR : public Register<0x4002201c> {
            ...
            using RAM_PARITY_CHECK = Field<14, 1>;    // RAM_PARITY_CHECK
