...
struct STM32F301 {
    ...
    struct RCC {
        ...
        struct CFGR : public Register<0x40021004> {
            ...
            using PLLNODIV = Field<31, 1>;    // Do not divide PLL to MCO
        };
        ...
        struct CFGR3 : public Register<0x40021030> {
            ...
            using TIM15SW = Field<10, 1>;    // Timer15 clock source selection
            using TIM16SW = Field<11, 1>;    // Timer16 clock source selection
            using TIM17SW = Field<13, 2>;    // Timer17 clock source selection
        };
    ...
    struct TIM2 {
        ...
        struct CR1 : public Register<0x40000000> {
            using UIFREMAP = Field<11, 2>;    // UIF status bit remapping
        ...
        struct CNT : public Register<0x40000024> {
            ...
            using CNT_or_UIFCPY = Field<31, 1>;    // CNT_or_UIFCPY
        };
    ...
    struct TIM19 {
        ...
        // event generation register
        struct EGR : public RegisterWriteOnly<0x40015c14> {
            using TG = Field<6, 1>;    // Trigger generation
            using CC4G = Field<4, 1>;    // Capture/compare 4 generation
            using CC3G = Field<3, 1>;    // Capture/compare 3 generation
            using CC2G = Field<2, 1>;    // Capture/compare 2 generation
    ...
    struct ADC {
        ...
        struct ISR : public Register<0x50000000> {
            using JQOVF = Field<10, 1>;    // Injected context queue overflow
            using AWD3 = Field<9, 1>;    // Analog watchdog 3 flag
            using AWD2 = Field<8, 1>;    // Analog watchdog 2 flag
            using AWD1 = Field<7, 1>;    // Analog watchdog 1 flag
            using JEOS = Field<6, 1>;    // Injected channel end of sequence flag
            using JEOC = Field<5, 1>;    // Injected channel end of conversion flag
            using OVR = Field<4, 1>;    // ADC overrun
            using EOS = Field<3, 1>;    // End of regular sequence flag
        ...
        struct IER : public Register<0x50000004> {
            using JQOVFIE = Field<10, 1>;    // Injected context queue overflow interrupt enable
            using AWD3IE = Field<9, 1>;    // Analog watchdog 3 interrupt enable
            using AWD2IE = Field<8, 1>;    // Analog watchdog 2 interrupt enable
            using AWD1IE = Field<7, 1>;    // Analog watchdog 1 interrupt enable
            using JEOSIE = Field<6, 1>;    // End of injected sequence of conversions interrupt enable
            using JEOCIE = Field<5, 1>;    // End of injected conversion interrupt enable
            using OVRIE = Field<4, 1>;    // Overrun interrupt enable
            using EOSIE = Field<3, 1>;    // End of regular sequence of conversions interrupt enable
            using EOCIE = Field<2, 1>;    // End of regular conversion interrupt enable
            using EOSMPIE = Field<1, 1>;    // End of sampling flag interrupt enable for regular conversions
        ...
        struct CR : public Register<0x50000008> {
            ...
            using ADCALDIF = Field<30, 1>;    // Differential mode for calibration
            using ADVREGEN = Field<28, 2>;    // ADC voltage regulator enable
            using JADST = Field<5, 1>;    // ADC stop of injected conversion command
            using ADSTP = Field<4, 1>;    // ADC stop of regular conversion command
            using JADSTART = Field<3, 1>;    // ADC start of injected conversion
            using ADSTART = Field<2, 1>;    // ADC start of regular conversion
            using ADDIS = Field<1, 1>;    // ADC disable command
            using ADEN = Field<0, 1>;    // ADC enable control
        };

        // ADC configuration register
        struct CFGR : public Register<0x5000000c> {
            using AWD1CH = Field<26, 5>;    // Analog watchdog 1 channel selection
            using JAUTO = Field<25, 1>;    // Automatic injected group conversion
            using JAWD1EN = Field<24, 1>;    // Analog watchdog 1 enable on injected channels
            using AWD1EN = Field<23, 1>;    // Analog watchdog 1 enable on regular channels
            using AWD1SGL = Field<22, 1>;    // Enable the watchdog 1 on a single channel or on all channels
            using JQM = Field<21, 1>;    // JSQR queue mode
            using JDISCEN = Field<20, 1>;    // Discontinuous mode on injected channels
            using DISCNUM = Field<17, 3>;    // Discontinuous mode channel count
            using DISCEN = Field<16, 1>;    // Discontinuous mode for regular channels
            using AUTDLY = Field<14, 1>;    // Delayed conversion mode
            using CONT = Field<13, 1>;    // Single / continuous conversion mode for regular conversions
            using OVRMOD = Field<12, 1>;    // Overrun Mode
            using EXTEN = Field<10, 2>;    // External trigger enable and polarity selection for regular channels
            using EXTSEL = Field<6, 4>;    // External trigger selection for regular group
            using ALIGN = Field<5, 1>;    // Data alignment
            using RES = Field<3, 2>;    // Data resolution
            using DMACFG = Field<1, 1>;    // Direct memory access configuration
        ...
        struct SMPR2 : public Register<0x50000018> {
            ...
            using SMP18 = Field<24, 3>;    // Channel 18 sampling time selection
        };

        // ADC watchdog threshold register 1
        struct TR1 : public Register<0x50000020> {
            using HT1 = Field<16, 12>;    // Analog watchdog 1 higher threshold
            using LT1 = Field<0, 12>;    // Analog watchdog 1 lower threshold
        };

        // ADC watchdog threshold register 2
        struct TR2 : public Register<0x50000024> {
            using HT2 = Field<16, 8>;    // Analog watchdog 2 higher threshold
            using LT2 = Field<0, 8>;    // Analog watchdog 2 lower threshold
        };

        // read-write
        struct TR3 : public Register<0x50000028> {
            using HT3 = Field<16, 8>;    // Analog watchdog 3 higher threshold
            using LT3 = Field<0, 8>;    // Analog watchdog 3 lower threshold
        };

        // ADC regular sequence register 1
        struct SQR1 : public Register<0x50000030> {
            using SQ4 = Field<24, 5>;    // 4th conversion in regular sequence
            using SQ3 = Field<18, 5>;    // 3rd conversion in regular sequence
            using SQ2 = Field<12, 5>;    // 2nd conversion in regular sequence
            using SQ1 = Field<6, 5>;    // 1st conversion in regular sequence
            using L = Field<0, 4>;    // Regular channel sequence length
        };

        // ADC regular sequence register 2
        struct SQR2 : public Register<0x50000034> {
            using SQ9 = Field<24, 5>;    // 9th conversion in regular sequence
            using SQ8 = Field<18, 5>;    // 8th conversion in regular sequence
            using SQ7 = Field<12, 5>;    // 7th conversion in regular sequence
            using SQ6 = Field<6, 5>;    // 6th conversion in regular sequence
            using SQ5 = Field<0, 5>;    // 5th conversion in regular sequence
        };

        // ADC regular sequence register 3
        struct SQR3 : public Register<0x50000038> {
            using SQ14 = Field<24, 5>;    // 14th conversion in regular sequence
            using SQ13 = Field<18, 5>;    // 13th conversion in regular sequence
            using SQ12 = Field<12, 5>;    // 13th conversion in regular sequence
            using SQ11 = Field<6, 5>;    // 11th conversion in regular sequence
            using SQ10 = Field<0, 5>;    // 10th conversion in regular sequence
        };

        // ADC regular sequence register 4
        struct SQR4 : public Register<0x5000003c> {
            using SQ16 = Field<6, 5>;    // 16th conversion in regular sequence
            using SQ15 = Field<0, 5>;    // 15th conversion in regular sequence
        };
        ...
        struct JSQR : public Register<0x5000004c> {
            using JSQ4 = Field<26, 5>;    // 4th conversion in the injected sequence
            using JSQ3 = Field<20, 5>;    // 3rd conversion in the injected sequence
            using JSQ2 = Field<14, 5>;    // 2nd conversion in the injected sequence
            using JSQ1 = Field<8, 5>;    // 1st conversion in the injected sequence
            using JEXTEN = Field<6, 2>;    // External Trigger Enable and Polarity Selection for injected channels
            using JEXTSEL = Field<2, 4>;    // External Trigger Selection for injected group
            using JL = Field<0, 2>;    // Injected channel sequence length
        };

        // ADC offset register1
        struct OFR1 : public Register<0x50000060> {
            using OFFSET1_EN = Field<31, 1>;    // Offset1 Enable
            using OFFSET1_CH = Field<26, 5>;    // Channel selection for the Data offset 1
            using OFFSET1 = Field<0, 12>;    // Data offset 1 for the channel programmed into bits OFFSET1_CH
        };

        // ADC offset register2
        struct OFR2 : public Register<0x50000064> {
            using OFFSET2_EN = Field<31, 1>;    // Offset 2 Enable
            using OFFSET2_CH = Field<26, 5>;    // Channel selection for the Data offset 2
            using OFFSET2 = Field<0, 12>;    // Data offset 2 for the channel programmed into bits OFFSET2_CH
        };

        // ADC offset register3
        struct OFR3 : public Register<0x50000068> {
            using OFFSET3_EN = Field<31, 1>;    // Offset y Enable
            using OFFSET3_CH = Field<26, 5>;    // Channel selection for the Data offset 3
            using OFFSET3 = Field<0, 12>;    // Data offset 3 for the channel programmed into bits OFFSET3_CH
        };

        // ADC offset register4
        struct OFR4 : public Register<0x5000006c> {
            using OFFSET4_EN = Field<31, 1>;    // Offset 4 Enable
            using OFFSET4_CH = Field<26, 5>;    // Channel selection for the Data offset 4
            using OFFSET4 = Field<0, 12>;    // Data offset 4 for the channel programmed into bits OFFSET4_CH
        };
        ...
        struct AWD2CR : public Register<0x500000a0> {
            using AWD2CH = Field<1, 18>;    // Analog watchdog 2 channel selection
        };

        // ADC Analog Watchdog 3 Configuration Register
        struct AWD3CR : public Register<0x500000a4> {
            using AWD3CH = Field<1, 18>;    // Analog watchdog 3 channel selection
        };

        // ADC Differential Mode Selection Register
        struct DIFSEL : public Register<0x500000b0> {
            using Field = Field<1, 18>;    // Differential mode for channels 15 to 1
        };

        // ADC Calibration Factors
        struct CALFACT : public Register<0x500000b4> {
            using CALFACT_D = Field<16, 7>;    // Calibration Factors in differential mode
            using CALFACT_S = Field<0, 7>;    // Calibration Factors In Single-Ended mode
        };

        // ADC Common status register
        struct CSR : public RegisterReadOnly<0x50000000> {
        ...
        struct CRR : public Register<0x50000008> {
            using VBATEN = Field<24, 1>;    // VBATEN
    ...
    struct SDADC1 {
        ...
        // interrupt and status register
        struct ISR : public RegisterReadOnly<0x40016008> {
        ...
        struct JDATAR : public RegisterReadOnly<0x40016060> {
        ...
        struct RDATAR : public RegisterReadOnly<0x40016064> {
            using RDATA = Field<0, 16>;    // Regular channel conversion data
        };

        // SDADC1 and SDADC2 injected data register
        struct JDATA12R : public RegisterReadOnly<0x40016070> {
        ...
        struct RDATA12R : public RegisterReadOnly<0x40016074> {
    ...
    struct SDADC2 {
        ...
        // interrupt and status register
        struct ISR : public RegisterReadOnly<0x40016408> {
            using INITRDY = Field<31, 1>;    // Initialization mode is ready
            using STABIP = Field<15, 1>;    // Stabilization in progress status
            using RCIP = Field<14, 1>;    // Regular conversion in progress status
            using JCIP = Field<13, 1>;    // Injected conversion in progress status
        ...
        // data register for injected group
        struct JDATAR : public RegisterReadOnly<0x40016460> {
            using JDATACH = Field<25, 4>;    // Injected channel most recently converted
            using JDATA = Field<0, 16>;    // Injected group conversion data
        };

        // data register for the regular channel
        struct RDATAR : public RegisterReadOnly<0x40016464> {
            using RDATA = Field<0, 16>;    // Regular channel conversion data
        };

        // SDADC1 and SDADC2 injected data register
        struct JDATA12R : public RegisterReadOnly<0x40016470> {
            using JDATA2 = Field<16, 16>;    // Injected group conversion data for SDADC2
            using JDATA1 = Field<0, 16>;    // Injected group conversion data for SDADC1
        };

        // SDADC1 and SDADC2 regular data register
        struct RDATA12R : public RegisterReadOnly<0x40016474> {
            using RDATA2 = Field<16, 16>;    // Regular conversion data for SDADC2
            using RDATA1 = Field<0, 16>;    // Regular conversion data for SDADC1
        };

        // SDADC1 and SDADC3 injected data register
        struct JDATA13R : public RegisterReadOnly<0x40016478> {
            using JDATA3 = Field<16, 16>;    // Injected group conversion data for SDADC3
            using JDATA1 = Field<0, 16>;    // Injected group conversion data for SDADC1
        };

        // SDADC1 and SDADC3 regular data register
        struct RDATA13R : public RegisterReadOnly<0x4001647c> {
            using RDATA3 = Field<16, 16>;    // Regular conversion data for SDADC3
            using RDATA1 = Field<0, 16>;    // Regular conversion data for SDADC1
        };
    ...
    struct SDADC3 {
        ...
        // interrupt and status register
        struct ISR : public RegisterReadOnly<0x40016808> {
            using INITRDY = Field<31, 1>;    // Initialization mode is ready
            using STABIP = Field<15, 1>;    // Stabilization in progress status
            using RCIP = Field<14, 1>;    // Regular conversion in progress status
            using JCIP = Field<13, 1>;    // Injected conversion in progress status
        ...
        // data register for injected group
        struct JDATAR : public RegisterReadOnly<0x40016860> {
            using JDATACH = Field<25, 4>;    // Injected channel most recently converted
            using JDATA = Field<0, 16>;    // Injected group conversion data
        };

        // data register for the regular channel
        struct RDATAR : public RegisterReadOnly<0x40016864> {
            using RDATA = Field<0, 16>;    // Regular channel conversion data
        };

        // SDADC1 and SDADC2 injected data register
        struct JDATA12R : public RegisterReadOnly<0x40016870> {
            using JDATA2 = Field<16, 16>;    // Injected group conversion data for SDADC2
            using JDATA1 = Field<0, 16>;    // Injected group conversion data for SDADC1
        };

        // SDADC1 and SDADC2 regular data register
        struct RDATA12R : public RegisterReadOnly<0x40016874> {
            using RDATA2 = Field<16, 16>;    // Regular conversion data for SDADC2
            using RDATA1 = Field<0, 16>;    // Regular conversion data for SDADC1
        };

        // SDADC1 and SDADC3 injected data register
        struct JDATA13R : public RegisterReadOnly<0x40016878> {
            using JDATA3 = Field<16, 16>;    // Injected group conversion data for SDADC3
            using JDATA1 = Field<0, 16>;    // Injected group conversion data for SDADC1
        };

        // SDADC1 and SDADC3 regular data register
        struct RDATA13R : public RegisterReadOnly<0x4001687c> {
            using RDATA3 = Field<16, 16>;    // Regular conversion data for SDADC3
            using RDATA1 = Field<0, 16>;    // Regular conversion data for SDADC1
        };
    ...
    struct DAC2 {
        ...
        struct SWTRIGR : public RegisterWriteOnly<0x40009804> {
        ...
        struct DOR1 : public RegisterReadOnly<0x4000982c> {
    ...
    struct TIM18 {
        ...
        // event generation register
        struct EGR : public RegisterWriteOnly<0x40009c14> {
            using UG = Field<0, 1>;    // Update generation
        };
