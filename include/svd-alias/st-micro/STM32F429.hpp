...
struct STM32F429 {
    ...
    struct FMC {
        ...
        struct BWTR3 : public Register<0xa0000104> {
            using ACCMOD = Field<28, 2>;    // ACCMOD
            using DATLAT = Field<24, 4>;    // DATLAT
            using CLKDIV = Field<20, 4>;    // CLKDIV
            using DATAST = Field<8, 8>;    // DATAST
        ...
        struct BWTR4 : public Register<0xa000010c> {
            using ACCMOD = Field<28, 2>;    // ACCMOD
            using DATLAT = Field<24, 4>;    // DATLAT
            using CLKDIV = Field<20, 4>;    // CLKDIV
            using DATAST = Field<8, 8>;    // DATAST
    ...
    struct RCC {
        ...
        struct DCKCFGR : public Register<0x4002388c> {
            using PLLI2SDIVQ = Field<0, 5>;    // PLLI2S division factor for SAI1 clock
            using PLLSAIDIVQ = Field<8, 5>;    // PLLSAI division factor for SAI1 clock
            using PLLSAIDIVR = Field<16, 2>;    // division factor for LCD_CLK
            using SAI1ASRC = Field<20, 2>;    // SAI1-A clock source selection
            using SAI1BSRC = Field<22, 2>;    // SAI1-B clock source selection
        ...
        struct PLLSAICFGR : public Register<0x40023888> {
            ...
            using PLLSAIQ = Field<24, 4>;    // PLLSAI division factor for SAI1 clock
    ...
    struct FLASH {
        ...
        struct CR : public Register<0x40023c10> {
            ...
            using MER1 = Field<15, 1>;    // Mass Erase of sectors 12 to 23
