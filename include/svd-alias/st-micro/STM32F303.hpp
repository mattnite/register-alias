...
struct STM32F303 {
    ...
    struct RCC {
        ...
        struct CFGR : public Register<0x40021004> {
            ...
            using PLLSRC = Field<15, 2>;    // PLL entry clock source
        ...
        struct APB1RSTR : public Register<0x40021010> {
            ...
            using I2C3RST = Field<30, 1>;    // I2C3 reset
        };
        ...
        struct AHBENR : public Register<0x40021014> {
            ...
            using FMCEN = Field<5, 1>;    // FMC clock enable
            using CRCEN = Field<6, 1>;    // CRC clock enable
            using IOPHEN = Field<16, 1>;    // IO port H clock enable
            ...
            using IOPGEN = Field<23, 1>;    // I/O port G clock enable
        ...
        struct APB1ENR : public Register<0x4002101c> {
            ...
            using USART4EN = Field<19, 1>;    // USART 4 clock enable
            using USART5EN = Field<20, 1>;    // USART 5 clock enable
        ...
        struct AHBRSTR : public Register<0x40021028> {
            using FMCRST = Field<5, 1>;    // FMC reset
            using IOPHRST = Field<16, 1>;    // I/O port H reset
            ...
            using IOPGRST = Field<23, 1>;    // Touch sensing controller reset
        ...
        struct CFGR3 : public Register<0x40021030> {
            ...
            using I2C3SW = Field<6, 1>;    // I2C3 clock source selection
    ...
    struct TIM20 {
        ...
        // capture/compare mode register 3 (output mode)
        struct CCMR3_Output : public Register<0x40015054> {
            using OC5FE = Field<2, 1>;    // Output compare 5 fast enable
            using OC5PE = Field<3, 1>;    // Output compare 5 preload enable
            using OC5M = Field<4, 3>;    // Output compare 5 mode
            using OC5CE = Field<7, 1>;    // Output compare 5 clear enable
        ...
        // capture/compare register 5
        struct CCR5 : public Register<0x40015058> {
            using Field = Field<0, 16>;    // Capture/Compare 5 value
            using GC5C1 = Field<29, 1>;    // Group Channel 5 and Channel 1
            using GC5C2 = Field<30, 1>;    // Group Channel 5 and Channel 2
            using GC5C3 = Field<31, 1>;    // Group Channel 5 and Channel 3
        ...
        // capture/compare register 6
        struct CCR6 : public Register<0x4001505c> {
            using Field = Field<0, 16>;    // Capture/Compare 6 value
        };

        // option registers
        struct OR : public Register<0x40015060> {
            using TIM1_ETR_ADC1_RMP = Field<0, 2>;    // TIM1_ETR_ADC1 remapping capability
            using TIM1_ETR_ADC4_RMP = Field<2, 2>;    // TIM1_ETR_ADC4 remapping capability
        };
    ...
    struct TIM8 {
        ...
        struct OR : public Register<0x40013460> {
            using TIM8_ETR_ADC2_RMP = Field<0, 2>;    // TIM8_ETR_ADC2 remapping capability
            using TIM8_ETR_ADC3_RMP = Field<2, 2>;    // TIM8_ETR_ADC3 remapping capability
        };
    ...
    struct ADC4 {
        ...
        // regular Data Register
        struct DR : public Register<0x50000540> {
            using regularDATA = Field<0, 16>;    // regularDATA
        };
        ...
        // injected data register 1
        struct JDR1 : public Register<0x50000580> {
            using JDATA1 = Field<0, 16>;    // JDATA1
        };

        // injected data register 2
        struct JDR2 : public Register<0x50000584> {
            using JDATA2 = Field<0, 16>;    // JDATA2
        };

        // injected data register 3
        struct JDR3 : public Register<0x50000588> {
            using JDATA3 = Field<0, 16>;    // JDATA3
        };

        // injected data register 4
        struct JDR4 : public Register<0x5000058c> {
            using JDATA4 = Field<0, 16>;    // JDATA4
        };
    ...
    struct ADC1_2 {
        ...
        struct CSR : public Register<0x50000300> {
        ...
        struct CCR : public Register<0x50000308> {
        ...
        struct CDR : public Register<0x5000030c> {
    ...
    struct SYSCFG_COMP_OPAMP {
        ...
        struct COMP1_CSR : public Register<0x4001001c> {
            ...
            using COMP1_OUT_SEL = Field<10, 4>;    // Comparator 1 output selection
            using COMP1POL = Field<15, 1>;    // Comparator 1 output polarity
            using COMP1HYST = Field<16, 2>;    // Comparator 1 hysteresis
            using COMP1_BLANKING = Field<18, 3>;    // Comparator 1 blanking source
            using COMP1OUT = Field<30, 1>;    // Comparator 1 output
            using COMP1LOCK = Field<31, 1>;    // Comparator 1 lock
        };
        ...
        // control and status register
        struct COMP3_CSR : public Register<0x40010024> {
            using COMP3EN = Field<0, 1>;    // Comparator 3 enable
            using COMP3MODE = Field<2, 2>;    // Comparator 3 mode
            using COMP3INSEL = Field<4, 3>;    // Comparator 3 inverting input selection
            using COMP3INPSEL = Field<7, 1>;    // Comparator 3 non inverted input selection
            using COMP3_OUT_SEL = Field<10, 4>;    // Comparator 3 output selection
            using COMP3POL = Field<15, 1>;    // Comparator 3 output polarity
            using COMP3HYST = Field<16, 2>;    // Comparator 3 hysteresis
            using COMP3_BLANKING = Field<18, 3>;    // Comparator 3 blanking source
            using COMP3OUT = Field<30, 1>;    // Comparator 3 output
            using COMP3LOCK = Field<31, 1>;    // Comparator 3 lock
        };
        ...
        // control and status register
        struct COMP5_CSR : public Register<0x4001002c> {
            using COMP5EN = Field<0, 1>;    // Comparator 5 enable
            using COMP5MODE = Field<2, 2>;    // Comparator 5 mode
            using COMP5INSEL = Field<4, 3>;    // Comparator 5 inverting input selection
            using COMP5INPSEL = Field<7, 1>;    // Comparator 5 non inverted input selection
            using COMP5_OUT_SEL = Field<10, 4>;    // Comparator 5 output selection
            using COMP5POL = Field<15, 1>;    // Comparator 5 output polarity
            using COMP5HYST = Field<16, 2>;    // Comparator 5 hysteresis
            using COMP5_BLANKING = Field<18, 3>;    // Comparator 5 blanking source
            using COMP5OUT = Field<30, 1>;    // Comparator51 output
            using COMP5LOCK = Field<31, 1>;    // Comparator 5 lock
        };
        ...
        // control and status register
        struct COMP7_CSR : public Register<0x40010034> {
            using COMP7EN = Field<0, 1>;    // Comparator 7 enable
            using COMP7MODE = Field<2, 2>;    // Comparator 7 mode
            using COMP7INSEL = Field<4, 3>;    // Comparator 7 inverting input selection
            using COMP7INPSEL = Field<7, 1>;    // Comparator 7 non inverted input selection
            using COMP7_OUT_SEL = Field<10, 4>;    // Comparator 7 output selection
            using COMP7POL = Field<15, 1>;    // Comparator 7 output polarity
            using COMP7HYST = Field<16, 2>;    // Comparator 7 hysteresis
            using COMP7_BLANKING = Field<18, 3>;    // Comparator 7 blanking source
            using COMP7OUT = Field<30, 1>;    // Comparator 7 output
            using COMP7LOCK = Field<31, 1>;    // Comparator 7 lock
        };

        // control register
        struct OPAMP1_CSR : public Register<0x40010038> {
            using OPAMP1_EN = Field<0, 1>;    // OPAMP1 enable
            using FORCE_VP = Field<1, 1>;    // FORCE_VP
            using VP_SEL = Field<2, 2>;    // OPAMP1 Non inverting input selection
            using VM_SEL = Field<5, 2>;    // OPAMP1 inverting input selection
            using TCM_EN = Field<7, 1>;    // Timer controlled Mux mode enable
            using VMS_SEL = Field<8, 1>;    // OPAMP1 inverting input secondary selection
            using VPS_SEL = Field<9, 2>;    // OPAMP1 Non inverting input secondary selection
            ...
            using OUTCAL = Field<30, 1>;    // OPAMP 1 ouput status flag
            using LOCK = Field<31, 1>;    // OPAMP 1 lock
        };
        ...
        // control register
        struct OPAMP3_CSR : public Register<0x40010040> {
            using OPAMP3EN = Field<0, 1>;    // OPAMP3 enable
            using FORCE_VP = Field<1, 1>;    // FORCE_VP
            using VP_SEL = Field<2, 2>;    // OPAMP3 Non inverting input selection
            using VM_SEL = Field<5, 2>;    // OPAMP3 inverting input selection
            using TCM_EN = Field<7, 1>;    // Timer controlled Mux mode enable
            using VMS_SEL = Field<8, 1>;    // OPAMP3 inverting input secondary selection
            using VPS_SEL = Field<9, 2>;    // OPAMP3 Non inverting input secondary selection
            using CALON = Field<11, 1>;    // Calibration mode enable
            using CALSEL = Field<12, 2>;    // Calibration selection
            using PGA_GAIN = Field<14, 4>;    // Gain in PGA mode
            using USER_TRIM = Field<18, 1>;    // User trimming enable
            ...
            using TRIMOFFSETN = Field<24, 5>;    // Offset trimming value (NMOS)
            using TSTREF = Field<29, 1>;    // TSTREF
            using OUTCAL = Field<30, 1>;    // OPAMP 3 ouput status flag
            using LOCK = Field<31, 1>;    // OPAMP 3 lock
        };

        // control register
        struct OPAMP4_CSR : public Register<0x40010044> {
            using OPAMP4EN = Field<0, 1>;    // OPAMP4 enable
            using FORCE_VP = Field<1, 1>;    // FORCE_VP
            using VP_SEL = Field<2, 2>;    // OPAMP4 Non inverting input selection
            using VM_SEL = Field<5, 2>;    // OPAMP4 inverting input selection
            using TCM_EN = Field<7, 1>;    // Timer controlled Mux mode enable
            using VMS_SEL = Field<8, 1>;    // OPAMP4 inverting input secondary selection
            using VPS_SEL = Field<9, 2>;    // OPAMP4 Non inverting input secondary selection
            using CALON = Field<11, 1>;    // Calibration mode enable
            using CALSEL = Field<12, 2>;    // Calibration selection
            using PGA_GAIN = Field<14, 4>;    // Gain in PGA mode
            using USER_TRIM = Field<18, 1>;    // User trimming enable
            ...
            using TRIMOFFSETN = Field<24, 5>;    // Offset trimming value (NMOS)
            using TSTREF = Field<29, 1>;    // TSTREF
            using OUTCAL = Field<30, 1>;    // OPAMP 4 ouput status flag
            using LOCK = Field<31, 1>;    // OPAMP 4 lock
        };
