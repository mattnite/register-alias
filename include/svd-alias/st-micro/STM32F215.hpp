...
struct STM32F215 {
    ...
    struct DBG {
        ...
        struct DBGMCU_APB1_FZ : public Register<0xe0042008> {
            ...
            using DBG_RTC_STOP = Field<10, 1>;    // DBG_RTC_STOP
    ...
    struct RCC {
        ...
        struct CFGR : public Register<0x40023808> {
            using MCO21 = Field<31, 1>;    // Microcontroller clock output 2
            using MCO20 = Field<30, 1>;    // Microcontroller clock output 2
            using MCO2PRE2 = Field<29, 1>;    // MCO2 prescaler
            using MCO2PRE1 = Field<28, 1>;    // MCO2 prescaler
            using MCO2PRE0 = Field<27, 1>;    // MCO2 prescaler
            using MCO1PRE2 = Field<26, 1>;    // MCO1 prescaler
            using MCO1PRE1 = Field<25, 1>;    // MCO1 prescaler
            using MCO1PRE0 = Field<24, 1>;    // MCO1 prescaler
            using I2SSRC = Field<23, 1>;    // I2S clock selection
            using MCO11 = Field<22, 1>;    // Microcontroller clock output 1
            using MCO10 = Field<21, 1>;    // Microcontroller clock output 1
            using RTCPRE4 = Field<20, 1>;    // HSE division factor for RTC clock
            using RTCPRE3 = Field<19, 1>;    // HSE division factor for RTC clock
            using RTCPRE2 = Field<18, 1>;    // HSE division factor for RTC clock
            using RTCPRE1 = Field<17, 1>;    // HSE division factor for RTC clock
            using RTCPRE0 = Field<16, 1>;    // HSE division factor for RTC clock
            using PPRE22 = Field<15, 1>;    // APB high-speed prescaler (APB2)
            using PPRE21 = Field<14, 1>;    // APB high-speed prescaler (APB2)
            using PPRE20 = Field<13, 1>;    // APB high-speed prescaler (APB2)
            using PPRE12 = Field<12, 1>;    // APB Low speed prescaler (APB1)
            using PPRE11 = Field<11, 1>;    // APB Low speed prescaler (APB1)
            using PPRE10 = Field<10, 1>;    // APB Low speed prescaler (APB1)
            using HPRE3 = Field<7, 1>;    // AHB prescaler
            using HPRE2 = Field<6, 1>;    // AHB prescaler
            using HPRE1 = Field<5, 1>;    // AHB prescaler
            using HPRE0 = Field<4, 1>;    // AHB prescaler
        ...
        struct PLLI2SCFGR : public Register<0x40023884> {
            using PLLI2SN0 = Field<6, 1>;    // PLLI2S multiplication factor for VCO
            using PLLI2SN1 = Field<7, 1>;    // PLLI2S multiplication factor for VCO
            using PLLI2SN2 = Field<8, 1>;    // PLLI2S multiplication factor for VCO
            using PLLI2SN3 = Field<9, 1>;    // PLLI2S multiplication factor for VCO
            using PLLI2SN4 = Field<10, 1>;    // PLLI2S multiplication factor for VCO
            using PLLI2SN5 = Field<11, 1>;    // PLLI2S multiplication factor for VCO
            using PLLI2SN6 = Field<12, 1>;    // PLLI2S multiplication factor for VCO
            using PLLI2SN7 = Field<13, 1>;    // PLLI2S multiplication factor for VCO
            using PLLI2SN8 = Field<14, 1>;    // PLLI2S multiplication factor for VCO
            using PLLI2SR0 = Field<28, 1>;    // PLLI2S division factor for I2S clocks
            using PLLI2SR1 = Field<29, 1>;    // PLLI2S division factor for I2S clocks
            using PLLI2SR2 = Field<30, 1>;    // PLLI2S division factor for I2S clocks
        };
    ...
    struct RTC {
        ...
        struct PRER : public Register<0x40002810> {
            ...
            using PREDIV_S = Field<0, 13>;    // Synchronous prescaler factor
        };
    ...
    struct TIM2 {
        ...
        struct TIM2_OR : public Register<0x40000050> {
    ...
    struct TIM5 {
        ...
        struct TIM5_OR : public Register<0x40000c50> {
            using IT4_RMP = Field<6, 2>;    // Timer Input 4 remap
        };
    ...
    struct Ethernet_MAC {
        ...
        struct MACFFR : public Register<0x40028004> {
            ...
            using PCF = Field<6, 1>;    // Pass control frames
        ...
        struct MACFCR : public Register<0x40028018> {
            using FCB = Field<0, 1>;    // Flow control busy/back pressure activate
            ...
            using PT = Field<16, 16>;    // Pause time
        };

        // Ethernet MAC VLAN tag register
        struct MACVLANTR : public Register<0x4002801c> {
            using VLANTI = Field<0, 16>;    // VLAN tag identifier
        ...
        struct MACDBGR : public Register<0x40028034> {
            using MMRPEA = Field<0, 1>;    // MAC MII receive protocol engine active
            using MSFRWCS = Field<1, 1>;    // MAC small FIFO read / write controllers status
            using RFWRA = Field<4, 1>;    // Rx FIFO write controller active
            using RFRCS = Field<5, 1>;    // Rx FIFO read controller status
            using RFFL = Field<8, 1>;    // Rx FIFO fill level
            using MMTEA = Field<16, 1>;    // MAC MII transmit engine active
            using MTFCS = Field<17, 2>;    // MAC transmit frame controller status
            using MTP = Field<19, 1>;    // MAC transmitter in pause
            using TFRS = Field<20, 2>;    // Tx FIFO read status
            using TFWA = Field<22, 1>;    // Tx FIFO write active
            using TFNE = Field<24, 1>;    // Tx FIFO not empty
            using TFF = Field<25, 1>;    // Tx FIFO full
        };
        ...
        struct MACA1LR : public Register<0x4002804c> {
            using Field = Field<0, 32>;    // MAC address1 low
        };

        // Ethernet MAC address 2 high register
        struct MACA2HR : public Register<0x40028050> {
            using MAC2AH = Field<0, 16>;    // MAC address2 high
            using MBC = Field<24, 6>;    // Mask byte control
            using SA = Field<30, 1>;    // Source address
            using AE = Field<31, 1>;    // Address enable
        };
    ...
    struct Ethernet_MMC {
        ...
        struct MMCCR : public Register<0x40028100> {
            ...
            using MCF = Field<3, 1>;    // MMC counter freeze
            using MCP = Field<4, 1>;    // MMC counter preset
            using MCFHP = Field<5, 1>;    // MMC counter Full-Half preset
        };
        ...
        struct MMCTGFSCCR : public Register<0x4002814c> {
            using TGFSCC = Field<0, 32>;    // Transmitted good frames single collision counter
        };

        // Ethernet MMC transmitted good frames after more than a single collision
        struct MMCTGFMSCCR : public Register<0x40028150> {
            using TGFMSCC = Field<0, 32>;    // Transmitted good frames more single collision counter
        };
        ...
        struct MMCRFCECR : public Register<0x40028194> {
            using RFCFC = Field<0, 32>;    // Received frames CRC error counter
        };

        // Ethernet MMC received frames with alignment error counter register
        struct MMCRFAECR : public Register<0x40028198> {
            using RFAEC = Field<0, 32>;    // Received frames alignment error counter
        };
    ...
    struct Ethernet_PTP {
        ...
        struct PTPTSCR : public Register<0x40028700> {
            ...
            using TTSARU = Field<5, 1>;    // Time stamp addend register update
            using TSSARFE = Field<8, 1>;    // Time stamp snapshot for all received frames enable
            using TSSSR = Field<9, 1>;    // Time stamp subsecond rollover: digital or binary rollover control
            using TSPTPPSV2E = Field<10, 1>;    // Time stamp PTP packet snooping for version2 format enable
            using TSSPTPOEFE = Field<11, 1>;    // Time stamp snapshot for PTP over ethernet frames enable
            using TSSIPV6FE = Field<12, 1>;    // Time stamp snapshot for IPv6 frames enable
            using TSSIPV4FE = Field<13, 1>;    // Time stamp snapshot for IPv4 frames enable
            using TSSEME = Field<14, 1>;    // Time stamp snapshot for event message enable
            using TSSMRME = Field<15, 1>;    // Time stamp snapshot for message relevant to master enable
            using TSCNT = Field<16, 2>;    // Time stamp clock node type
            using TSPFFMAE = Field<18, 1>;    // Time stamp PTP frame filtering MAC address enable
        };
        ...
        struct PTPTSSR : public Register<0x40028728> {
            using TSSO = Field<0, 1>;    // Time stamp second overflow
            using TSTTR = Field<1, 1>;    // Time stamp target time reached
        };

        // Ethernet PTP PPS control register
        struct PTPPPSCR : public Register<0x4002872c> {
            using PPSFREQ = Field<0, 4>;    // PPS frequency selection
        };
    ...
    struct Ethernet_DMA {
        ...
        struct DMABMR : public Register<0x40029000> {
            ...
            using EDFE = Field<7, 1>;    // Enhanced descriptor format enable
            ...
            using MB = Field<26, 1>;    // Mixed burst
        };
        ...
        struct DMARSWTR : public Register<0x40029024> {
            using RSWTC = Field<0, 8>;    // Receive status watchdog timer count
        };
    ...
    struct HASH {
        ...
        struct CR : public Register<0x50060400> {
            ...
            using ALGO = Field<7, 1>;    // Algorithm selection
    ...
    struct CRYP {
        ...
        struct CR : public Register<0x50060000> {
            ...
            using ALGOMODE = Field<3, 3>;    // Algorithm mode
