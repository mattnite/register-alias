...
struct STM32F7x3 {
    ...
    struct C_ADC {
        ...
        struct CDR : public RegisterReadOnly<0x40012308> {
    ...
    struct TIM13 {
        ...
        // slave mode control register
        struct SMCR : public RegisterReadOnly<0x40001c08> {
    ...
    struct TIM14 {
        ...
        // slave mode control register
        struct SMCR : public RegisterReadOnly<0x40002008> {
            using Res = Field<0, 32>;    // Res.
        };
    ...
    struct TIM10 {
        ...
        // slave mode control register
        struct SMCR : public RegisterReadOnly<0x40014408> {
            using Res = Field<0, 32>;    // Res.
        };
    ...
    struct TIM11 {
        ...
        // slave mode control register
        struct SMCR : public RegisterReadOnly<0x40014808> {
            using Res = Field<0, 32>;    // Res.
        };
    ...
    struct SAI1 {
        ...
        // AStatus register
        struct ASR : public RegisterReadOnly<0x40015818> {
            using FLVL = Field<16, 3>;    // FIFO level threshold
            using LFSDET = Field<6, 1>;    // Late frame synchronization detection
            using AFSDET = Field<5, 1>;    // Anticipated frame synchronization detection
            using CNRDY = Field<4, 1>;    // Codec not ready
        ...
        struct ACLRFR : public RegisterWriteOnly<0x4001581c> {
            using CLFSDET = Field<6, 1>;    // Clear late frame synchronization detection flag
            using CAFSDET = Field<5, 1>;    // Clear anticipated frame synchronization detection flag.
            using CCNRDY = Field<4, 1>;    // Clear codec not ready flag
            using CWCKCFG = Field<2, 1>;    // Clear wrong clock configuration flag
    ...
    struct SAI2 {
        ...
        // AStatus register
        struct ASR : public RegisterReadOnly<0x40015c18> {
            using FLVL = Field<16, 3>;    // FIFO level threshold
            using LFSDET = Field<6, 1>;    // Late frame synchronization detection
            using AFSDET = Field<5, 1>;    // Anticipated frame synchronization detection
            using CNRDY = Field<4, 1>;    // Codec not ready
        ...
        // AClear flag register
        struct ACLRFR : public RegisterWriteOnly<0x40015c1c> {
            using CLFSDET = Field<6, 1>;    // Clear late frame synchronization detection flag
            using CAFSDET = Field<5, 1>;    // Clear anticipated frame synchronization detection flag.
            using CCNRDY = Field<4, 1>;    // Clear codec not ready flag
            using CWCKCFG = Field<2, 1>;    // Clear wrong clock configuration flag
    ...
    struct OTG_HS_GLOBAL {
        ...
        struct OTG_HS_HNPTXSTS : public RegisterReadOnly<0x4004002c> {
    ...
    static std::uint32_t const numInterrupts = 104;
