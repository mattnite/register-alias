...
struct STM32F446 {
    ...
    struct SDMMC {
        ...
        struct SDMMC_RESP1R : public RegisterReadOnly<0x40012c10> {
            using CARDSTATUS1 = Field<0, 32>;    // see Table404.
        };

        // The SDMMC_RESP1/2/3/4R registers contain the status of a card, which is part of the received response.
        struct SDMMC_RESP2R : public RegisterReadOnly<0x40012c14> {
            using CARDSTATUS2 = Field<0, 32>;    // see Table404.
        };

        // The SDMMC_RESP1/2/3/4R registers contain the status of a card, which is part of the received response.
        struct SDMMC_RESP3R : public RegisterReadOnly<0x40012c18> {
            using CARDSTATUS3 = Field<0, 32>;    // see Table404.
        };

        // The SDMMC_RESP1/2/3/4R registers contain the status of a card, which is part of the received response.
        struct SDMMC_RESP4R : public RegisterReadOnly<0x40012c1c> {
        ...
        struct SDMMC_DCNTR : public RegisterReadOnly<0x40012c30> {
        ...
        struct SDMMC_STAR : public RegisterReadOnly<0x40012c34> {
        ...
        struct SDMMC_RESPCMDR : public RegisterReadOnly<0x40012c60> {
        ...
        struct SDMMC_VER : public RegisterReadOnly<0x40012ff4> {
        ...
        struct SDMMC_ID : public RegisterReadOnly<0x40012ff8> {
    ...
    struct HDMI_CEC {
        ...
        struct CEC_TXDR : public RegisterWriteOnly<0x40006c08> {
            using TXD = Field<0, 8>;    // Tx Data register
        };

        // CEC Rx Data Register
        struct CEC_RXDR : public RegisterReadOnly<0x40006c0c> {
    ...
    static std::uint32_t const numInterrupts = 90;
