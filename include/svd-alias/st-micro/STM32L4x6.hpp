...
struct STM32L4x6 {
    ...
    struct RCC {
        ...
        struct AHB2RSTR : public Register<0x4002102c> {
            ...
            using HASH1RST = Field<17, 1>;    // Hash reset
        };
        ...
        struct APB2RSTR : public Register<0x40021040> {
            using DFSDMRST = Field<24, 1>;    // Digital filters for sigma-delata modulators (DFSDM) reset
        ...
        struct AHB2ENR : public Register<0x4002104c> {
            ...
            using HASH1EN = Field<17, 1>;    // HASH clock enable
        };
        ...
        struct APB2ENR : public Register<0x40021060> {
            using DFSDMEN = Field<24, 1>;    // DFSDM timer clock enable
        ...
        struct AHB2SMENR : public Register<0x4002106c> {
            ...
            using HASH1SMEN = Field<17, 1>;    // HASH clock enable during Sleep and Stop modes
        };
        ...
        struct APB1SMENR1 : public Register<0x40021078> {
            ...
            using CAN2SMEN = Field<26, 1>;    // CAN2 clocks enable during Sleep and Stop modes
        };
        ...
        struct APB2SMENR : public Register<0x40021080> {
            using DFSDMSMEN = Field<24, 1>;    // DFSDM timer clocks enable during Sleep and Stop modes
        ...
        struct CCIPR : public Register<0x40021088> {
            using DFSDMSEL = Field<31, 1>;    // DFSDM clock source selection
    ...
    struct ADC1 {
        ...
        struct CFGR : public Register<0x5004000c> {
            ...
            using DFSDMCFG = Field<2, 1>;    // DFSDMCFG
    ...
    struct ADC2 {
        // interrupt and status register
        struct ISR : public Register<0x50040100> {
            using JQOVF = Field<10, 1>;    // JQOVF
            using AWD3 = Field<9, 1>;    // AWD3
            using AWD2 = Field<8, 1>;    // AWD2
            using AWD1 = Field<7, 1>;    // AWD1
        ...
        // interrupt enable register
        struct IER : public Register<0x50040104> {
            using JQOVFIE = Field<10, 1>;    // JQOVFIE
            using AWD3IE = Field<9, 1>;    // AWD3IE
            using AWD2IE = Field<8, 1>;    // AWD2IE
            using AWD1IE = Field<7, 1>;    // AWD1IE
        ...
        // control register
        struct CR : public Register<0x50040108> {
            using ADCAL = Field<31, 1>;    // ADCAL
            using ADCALDIF = Field<30, 1>;    // ADCALDIF
            using DEEPPWD = Field<29, 1>;    // DEEPPWD
            using ADVREGEN = Field<28, 1>;    // ADVREGEN
        ...
        // configuration register
        struct CFGR : public Register<0x5004010c> {
            using JQDIS = Field<31, 1>;    // Injected Queue disable
            using AWDCH1CH = Field<26, 5>;    // AWDCH1CH
            using JAUTO = Field<25, 1>;    // JAUTO
            using JAWD1EN = Field<24, 1>;    // JAWD1EN
        ...
        // configuration register
        struct CFGR2 : public Register<0x50040110> {
            using ROVSM = Field<10, 1>;    // EXTEN
            using TROVS = Field<9, 1>;    // Triggered Regular Oversampling
            using OVSS = Field<5, 4>;    // ALIGN
            using OVSR = Field<2, 3>;    // RES
        ...
        // sample time register 1
        struct SMPR1 : public Register<0x50040114> {
            using SMP9 = Field<27, 3>;    // SMP9
            using SMP8 = Field<24, 3>;    // SMP8
            using SMP7 = Field<21, 3>;    // SMP7
            using SMP6 = Field<18, 3>;    // SMP6
        ...
        // sample time register 2
        struct SMPR2 : public Register<0x50040118> {
            using SMP18 = Field<24, 3>;    // SMP18
            using SMP17 = Field<21, 3>;    // SMP17
            using SMP16 = Field<18, 3>;    // SMP16
            using SMP15 = Field<15, 3>;    // SMP15
        ...
        // watchdog threshold register 1
        struct TR1 : public Register<0x50040120> {
            using HT1 = Field<16, 12>;    // HT1
            using LT1 = Field<0, 12>;    // LT1
        };

        // watchdog threshold register
        struct TR2 : public Register<0x50040124> {
            using HT2 = Field<16, 8>;    // HT2
            using LT2 = Field<0, 8>;    // LT2
        };

        // watchdog threshold register 3
        struct TR3 : public Register<0x50040128> {
            using HT3 = Field<16, 8>;    // HT3
            using LT3 = Field<0, 8>;    // LT3
        };

        // regular sequence register 1
        struct SQR1 : public Register<0x50040130> {
            using SQ4 = Field<24, 5>;    // SQ4
            using SQ3 = Field<18, 5>;    // SQ3
            using SQ2 = Field<12, 5>;    // SQ2
            using SQ1 = Field<6, 5>;    // SQ1
        ...
        // regular sequence register 2
        struct SQR2 : public Register<0x50040134> {
            using SQ9 = Field<24, 5>;    // SQ9
            using SQ8 = Field<18, 5>;    // SQ8
            using SQ7 = Field<12, 5>;    // SQ7
            using SQ6 = Field<6, 5>;    // SQ6
        ...
        // regular sequence register 3
        struct SQR3 : public Register<0x50040138> {
            using SQ14 = Field<24, 5>;    // SQ14
            using SQ13 = Field<18, 5>;    // SQ13
            using SQ12 = Field<12, 5>;    // SQ12
            using SQ11 = Field<6, 5>;    // SQ11
        ...
        // regular sequence register 4
        struct SQR4 : public Register<0x5004013c> {
            using SQ16 = Field<6, 5>;    // SQ16
            using SQ15 = Field<0, 5>;    // SQ15
        };

        // regular Data Register
        struct DR : public RegisterReadOnly<0x50040140> {
            using RDATA = Field<0, 16>;    // Regular Data converted
        };

        // injected sequence register
        struct JSQR : public Register<0x5004014c> {
            using JSQ4 = Field<26, 5>;    // JSQ4
            using JSQ3 = Field<20, 5>;    // JSQ3
            using JSQ2 = Field<14, 5>;    // JSQ2
            using JSQ1 = Field<8, 5>;    // JSQ1
        ...
        // offset register 1
        struct OFR1 : public Register<0x50040160> {
            using OFFSET1_EN = Field<31, 1>;    // OFFSET1_EN
            using OFFSET1_CH = Field<26, 5>;    // OFFSET1_CH
            using OFFSET1 = Field<0, 12>;    // OFFSET1
        };
        ...
        // offset register 2
        struct OFR2 : public Register<0x50040164> {
            using OFFSET2_EN = Field<31, 1>;    // OFFSET2_EN
            using OFFSET2_CH = Field<26, 5>;    // OFFSET2_CH
            using OFFSET2 = Field<0, 12>;    // OFFSET2
        };
        ...
        // offset register 3
        struct OFR3 : public Register<0x50040168> {
            using OFFSET3_EN = Field<31, 1>;    // OFFSET3_EN
            using OFFSET3_CH = Field<26, 5>;    // OFFSET3_CH
            using OFFSET3 = Field<0, 12>;    // OFFSET3
        };
        ...
        // offset register 4
        struct OFR4 : public Register<0x5004016c> {
            using OFFSET4_EN = Field<31, 1>;    // OFFSET4_EN
            using OFFSET4_CH = Field<26, 5>;    // OFFSET4_CH
            using OFFSET4 = Field<0, 12>;    // OFFSET4
        };
        ...
        // injected data register 1
        struct JDR1 : public RegisterReadOnly<0x50040180> {
            using JDATA1 = Field<0, 16>;    // JDATA1
        };

        // injected data register 2
        struct JDR2 : public RegisterReadOnly<0x50040184> {
            using JDATA2 = Field<0, 16>;    // JDATA2
        };

        // injected data register 3
        struct JDR3 : public RegisterReadOnly<0x50040188> {
            using JDATA3 = Field<0, 16>;    // JDATA3
        };

        // injected data register 4
        struct JDR4 : public RegisterReadOnly<0x5004018c> {
            using JDATA4 = Field<0, 16>;    // JDATA4
        };

        // Analog Watchdog 2 Configuration Register
        struct AWD2CR : public Register<0x500401a0> {
            using AWD2CH = Field<0, 19>;    // AWD2CH
        };

        // Analog Watchdog 3 Configuration Register
        struct AWD3CR : public Register<0x500401a4> {
            using AWD3CH = Field<0, 19>;    // AWD3CH
        };

        // Differential Mode Selection Register 2
        struct DIFSEL : public Register<0x500401b0> {
            using DIFSEL_0 = Field<0, 1>;    // Differential mode for channels 0
            using DIFSEL_1_15 = Field<1, 15>;    // Differential mode for channels 15 to 1
            using DIFSEL_16_18 = Field<16, 3>;    // Differential mode for channels 18 to 16
        };
        ...
        // Calibration Factors
        struct CALFACT : public Register<0x500401b4> {
            using CALFACT_D = Field<16, 7>;    // CALFACT_D
            using CALFACT_S = Field<0, 7>;    // CALFACT_S
        };
    ...
    struct ADC3 {
        // interrupt and status register
        struct ISR : public Register<0x50040200> {
            using JQOVF = Field<10, 1>;    // JQOVF
            using AWD3 = Field<9, 1>;    // AWD3
            using AWD2 = Field<8, 1>;    // AWD2
            using AWD1 = Field<7, 1>;    // AWD1
        ...
        // interrupt enable register
        struct IER : public Register<0x50040204> {
            using JQOVFIE = Field<10, 1>;    // JQOVFIE
            using AWD3IE = Field<9, 1>;    // AWD3IE
            using AWD2IE = Field<8, 1>;    // AWD2IE
            using AWD1IE = Field<7, 1>;    // AWD1IE
        ...
        // control register
        struct CR : public Register<0x50040208> {
            using ADCAL = Field<31, 1>;    // ADCAL
            using ADCALDIF = Field<30, 1>;    // ADCALDIF
            using DEEPPWD = Field<29, 1>;    // DEEPPWD
            using ADVREGEN = Field<28, 1>;    // ADVREGEN
        ...
        // configuration register
        struct CFGR : public Register<0x5004020c> {
            using JQDIS = Field<31, 1>;    // Injected Queue disable
            using AWDCH1CH = Field<26, 5>;    // AWDCH1CH
            using JAUTO = Field<25, 1>;    // JAUTO
            using JAWD1EN = Field<24, 1>;    // JAWD1EN
        ...
        // configuration register
        struct CFGR2 : public Register<0x50040210> {
            using ROVSM = Field<10, 1>;    // EXTEN
            using TROVS = Field<9, 1>;    // Triggered Regular Oversampling
            using OVSS = Field<5, 4>;    // ALIGN
            using OVSR = Field<2, 3>;    // RES
        ...
        // sample time register 1
        struct SMPR1 : public Register<0x50040214> {
            using SMP9 = Field<27, 3>;    // SMP9
            using SMP8 = Field<24, 3>;    // SMP8
            using SMP7 = Field<21, 3>;    // SMP7
            using SMP6 = Field<18, 3>;    // SMP6
        ...
        // sample time register 2
        struct SMPR2 : public Register<0x50040218> {
            using SMP18 = Field<24, 3>;    // SMP18
            using SMP17 = Field<21, 3>;    // SMP17
            using SMP16 = Field<18, 3>;    // SMP16
            using SMP15 = Field<15, 3>;    // SMP15
        ...
        // watchdog threshold register 1
        struct TR1 : public Register<0x50040220> {
            using HT1 = Field<16, 12>;    // HT1
            using LT1 = Field<0, 12>;    // LT1
        };

        // watchdog threshold register
        struct TR2 : public Register<0x50040224> {
            using HT2 = Field<16, 8>;    // HT2
            using LT2 = Field<0, 8>;    // LT2
        };

        // watchdog threshold register 3
        struct TR3 : public Register<0x50040228> {
            using HT3 = Field<16, 8>;    // HT3
            using LT3 = Field<0, 8>;    // LT3
        };

        // regular sequence register 1
        struct SQR1 : public Register<0x50040230> {
            using SQ4 = Field<24, 5>;    // SQ4
            using SQ3 = Field<18, 5>;    // SQ3
            using SQ2 = Field<12, 5>;    // SQ2
            using SQ1 = Field<6, 5>;    // SQ1
        ...
        // regular sequence register 2
        struct SQR2 : public Register<0x50040234> {
            using SQ9 = Field<24, 5>;    // SQ9
            using SQ8 = Field<18, 5>;    // SQ8
            using SQ7 = Field<12, 5>;    // SQ7
            using SQ6 = Field<6, 5>;    // SQ6
        ...
        // regular sequence register 3
        struct SQR3 : public Register<0x50040238> {
            using SQ14 = Field<24, 5>;    // SQ14
            using SQ13 = Field<18, 5>;    // SQ13
            using SQ12 = Field<12, 5>;    // SQ12
            using SQ11 = Field<6, 5>;    // SQ11
        ...
        // regular sequence register 4
        struct SQR4 : public Register<0x5004023c> {
            using SQ16 = Field<6, 5>;    // SQ16
            using SQ15 = Field<0, 5>;    // SQ15
        };

        // regular Data Register
        struct DR : public RegisterReadOnly<0x50040240> {
            using RDATA = Field<0, 16>;    // Regular Data converted
        };

        // injected sequence register
        struct JSQR : public Register<0x5004024c> {
            using JSQ4 = Field<26, 5>;    // JSQ4
            using JSQ3 = Field<20, 5>;    // JSQ3
            using JSQ2 = Field<14, 5>;    // JSQ2
            using JSQ1 = Field<8, 5>;    // JSQ1
        ...
        // offset register 1
        struct OFR1 : public Register<0x50040260> {
            using OFFSET1_EN = Field<31, 1>;    // OFFSET1_EN
            using OFFSET1_CH = Field<26, 5>;    // OFFSET1_CH
            using OFFSET1 = Field<0, 12>;    // OFFSET1
        };
        ...
        // offset register 2
        struct OFR2 : public Register<0x50040264> {
            using OFFSET2_EN = Field<31, 1>;    // OFFSET2_EN
            using OFFSET2_CH = Field<26, 5>;    // OFFSET2_CH
            using OFFSET2 = Field<0, 12>;    // OFFSET2
        };
        ...
        // offset register 3
        struct OFR3 : public Register<0x50040268> {
            using OFFSET3_EN = Field<31, 1>;    // OFFSET3_EN
            using OFFSET3_CH = Field<26, 5>;    // OFFSET3_CH
            using OFFSET3 = Field<0, 12>;    // OFFSET3
        };
        ...
        // offset register 4
        struct OFR4 : public Register<0x5004026c> {
            using OFFSET4_EN = Field<31, 1>;    // OFFSET4_EN
            using OFFSET4_CH = Field<26, 5>;    // OFFSET4_CH
            using OFFSET4 = Field<0, 12>;    // OFFSET4
        };
        ...
        // injected data register 1
        struct JDR1 : public RegisterReadOnly<0x50040280> {
            using JDATA1 = Field<0, 16>;    // JDATA1
        };

        // injected data register 2
        struct JDR2 : public RegisterReadOnly<0x50040284> {
            using JDATA2 = Field<0, 16>;    // JDATA2
        };

        // injected data register 3
        struct JDR3 : public RegisterReadOnly<0x50040288> {
            using JDATA3 = Field<0, 16>;    // JDATA3
        };

        // injected data register 4
        struct JDR4 : public RegisterReadOnly<0x5004028c> {
            using JDATA4 = Field<0, 16>;    // JDATA4
        };

        // Analog Watchdog 2 Configuration Register
        struct AWD2CR : public Register<0x500402a0> {
            using AWD2CH = Field<0, 19>;    // AWD2CH
        };

        // Analog Watchdog 3 Configuration Register
        struct AWD3CR : public Register<0x500402a4> {
            using AWD3CH = Field<0, 19>;    // AWD3CH
        };

        // Differential Mode Selection Register 2
        struct DIFSEL : public Register<0x500402b0> {
            using DIFSEL_0 = Field<0, 1>;    // Differential mode for channels 0
            using DIFSEL_1_15 = Field<1, 15>;    // Differential mode for channels 15 to 1
            using DIFSEL_16_18 = Field<16, 3>;    // Differential mode for channels 18 to 16
        };
        ...
        // Calibration Factors
        struct CALFACT : public Register<0x500402b4> {
            using CALFACT_D = Field<16, 7>;    // CALFACT_D
            using CALFACT_S = Field<0, 7>;    // CALFACT_S
        };
    ...
    struct ADC_Common {
        ...
        struct CSR : public RegisterReadOnly<0x50040300> {
        ...
        struct CDR : public RegisterReadOnly<0x5004030c> {
    ...
    struct GPIOI {
        ...
        // GPIO port input data register
        struct IDR : public RegisterReadOnly<0x48002010> {
            using IDR15 = Field<15, 1>;    // Port input data (y = 0..15)
            using IDR14 = Field<14, 1>;    // Port input data (y = 0..15)
            using IDR13 = Field<13, 1>;    // Port input data (y = 0..15)
            using IDR12 = Field<12, 1>;    // Port input data (y = 0..15)
        ...
        // GPIO port bit set/reset register
        struct BSRR : public RegisterWriteOnly<0x48002018> {
            using BR15 = Field<31, 1>;    // Port x reset bit y (y = 0..15)
            using BR14 = Field<30, 1>;    // Port x reset bit y (y = 0..15)
            using BR13 = Field<29, 1>;    // Port x reset bit y (y = 0..15)
            using BR12 = Field<28, 1>;    // Port x reset bit y (y = 0..15)
        ...
        // GPIO port bit reset register
        struct BRR : public RegisterWriteOnly<0x48002028> {
            using BR0 = Field<0, 1>;    // Port Reset bit
            using BR1 = Field<1, 1>;    // Port Reset bit
            using BR2 = Field<2, 1>;    // Port Reset bit
            using BR3 = Field<3, 1>;    // Port Reset bit
    ...
    static std::uint32_t const numInterrupts = 91;
