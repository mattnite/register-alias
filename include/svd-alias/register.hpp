...
struct RegisterWriteOnly {
	...
	static void write() {
		...
		*ptr = (*ptr & ~(Pairs::Field::mask | ...)) | ((Pairs::Field::mask & ...) & ((Pairs::value << Pairs::Field::offset) | ...));
	}

	template <typename ...FieldValues>
	static void write(FieldValues&& ...fieldValues) {
		auto ptr = reinterpret_cast<volatile T*>(address);
		*ptr = (*ptr & ~(FieldValuess::Field::mask | ...)) | ((FieldValues::Field::mask & ...) & ((fieldValues.value << FieldValues::Field::offset) | ...));
	}
};
